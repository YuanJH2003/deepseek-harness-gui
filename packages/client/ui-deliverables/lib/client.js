window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:D:\tool\deepseek-harness\packages\client\ui-deliverables\src\client\ProducedFiles.module.css.mjs
		const css = ".mKezxW_root{grid-template-columns:max-content minmax(0,1fr);align-items:center;gap:6px 8px;margin-top:16px;font-size:13px;line-height:22px;display:grid;position:relative}.mKezxW_label{color:var(--dsw-alias-label-tertiary);grid-area:1/1}.mKezxW_row{flex-wrap:nowrap;grid-area:1/2;align-items:center;gap:8px;min-width:0;display:flex;overflow:hidden}.mKezxW_file{text-overflow:ellipsis;white-space:nowrap;background:var(--dsw-alias-interactive-bg-hover);max-width:320px;color:var(--dsw-alias-label-secondary);font:inherit;cursor:pointer;border:none;border-radius:6px;flex:none;margin:0;padding:0 8px;overflow:hidden}.mKezxW_file:hover{color:var(--dsw-alias-label-primary);text-decoration:underline}.mKezxW_file:focus-visible,.mKezxW_showFolder:focus-visible{box-shadow:inset 0 0 0 2px var(--dsw-alias-border-l3);outline:none}.mKezxW_more{white-space:nowrap;color:var(--dsw-alias-label-tertiary);flex:none}.mKezxW_showFolder{color:var(--dsw-alias-label-tertiary);font:inherit;cursor:pointer;background:0 0;border:none;border-radius:4px;grid-area:2/2;justify-self:start;margin:0;padding:0 2px;line-height:20px}.mKezxW_showFolder:hover{color:var(--dsw-alias-label-secondary);text-decoration:underline}.mKezxW_measure{visibility:hidden;pointer-events:none;contain:strict;width:0;height:0;position:absolute;overflow:hidden}.mKezxW_probe{width:max-content;position:absolute;inset:0 auto auto 0}";
		...
		var ProducedFiles_module_css_default = {
			...
			"more": "mKezxW_more",
			"label": "mKezxW_label",
			"showFolder": "mKezxW_showFolder",
			"measure": "mKezxW_measure"
		};
		//#endregion
