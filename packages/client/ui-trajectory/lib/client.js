window.__ModuleLoader__.load({
 ...
 /* istanbul ignore else */
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:D:\tool\deepseek-harness\packages\client\ui-trajectory\src\client\TrajectoryTable.module.css.mjs
		const css$3 = ".e4KDVa_split{--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);background:var(--dsw-alias-bg-layer-1);flex:1;width:100%;min-height:0;display:flex;position:relative;overflow:hidden;container-type:inline-size}.e4KDVa_tablePane{min-width:0;padding-bottom:var(--dsh-trajectory-bottom-clearance,0px);flex:1;position:relative;overflow:hidden auto;container:e4KDVa_trajectory-table/inline-size}.e4KDVa_historyLoading{z-index:5;pointer-events:none;height:0;position:sticky;top:0;overflow:visible}.e4KDVa_historyLoadingBar{box-sizing:border-box;border-bottom:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-1);width:100%;height:30px;color:var(--dsw-alias-label-secondary);font:var(--dsw-font-xxs-12);justify-content:center;align-items:center;gap:6px;display:flex}.e4KDVa_historyLoadingSpinner{box-sizing:border-box;border:1.5px solid var(--dsw-alias-border-l2);border-top-color:var(--dsw-alias-state-business-primary);border-radius:50%;width:10px;height:10px;animation:.7s linear infinite e4KDVa_history-loading-spin}.e4KDVa_table tbody .e4KDVa_historyLoadRow td{height:30px;padding:0}.e4KDVa_table tbody .e4KDVa_historyLoadRow+tr[data-turn-start=true] td:before{content:none}.e4KDVa_historyLoadButton{background:var(--dsw-alias-bg-layer-1);width:100%;height:29px;color:var(--dsw-alias-label-secondary);cursor:pointer;font:var(--dsw-font-xxs-12);border:0;justify-content:center;align-items:center;gap:6px;display:flex}.e4KDVa_historyLoadButton:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-primary)}.e4KDVa_historyLoadButton:focus-visible{outline:2px solid var(--dsw-alias-state-business-primary);outline-offset:-2px}.e4KDVa_historyLoadButton:disabled{cursor:default}.e4KDVa_visuallyHidden{clip:rect(0 0 0 0);white-space:nowrap;width:1px;height:1px;position:absolute;overflow:hidden}.e4KDVa_table:not([data-scroll-ready=true]){visibility:hidden}@keyframes e4KDVa_history-loading-spin{to{transform:rotate(360deg)}}@media (prefers-reduced-motion:reduce){.e4KDVa_historyLoadingSpinner{animation:none}}.e4KDVa_table{--trajectory-turn-accent:color-mix(in srgb, var(--dsw-static-blue-500) 22%, var(--dsw-alias-bg-layer-1));border-spacing:0;table-layout:fixed;width:100%;min-width:0;color:var(--dsw-alias-label-primary);background:var(--dsw-alias-bg-layer-1);font:var(--dsw-font-xxs-12)}.e4KDVa_eventColumn{width:122px}.e4KDVa_contentColumn{width:auto}.e4KDVa_table th{z-index:3;box-sizing:border-box;border-bottom:1px solid var(--dsw-alias-border-l2);height:30px;color:var(--dsw-alias-label-tertiary);background:var(--dsw-specific-sidebar-fill);font:var(--dsw-font-xxs-12);text-align:left;text-overflow:ellipsis;user-select:none;white-space:nowrap;padding:0 8px;font-weight:500;position:sticky;top:0;overflow:hidden}.e4KDVa_eventHeader{text-align:right!important;padding-right:4px!important}.e4KDVa_table td{box-sizing:border-box;border-bottom:1px solid var(--dsw-alias-border-l1);text-overflow:ellipsis;white-space:nowrap;height:30px;padding:0 8px;overflow:hidden}.e4KDVa_table tbody .e4KDVa_virtualSpacer{pointer-events:none}.e4KDVa_table tbody .e4KDVa_virtualSpacer td{height:var(--trajectory-virtual-spacer-height);border:0;padding:0}.e4KDVa_table tbody tr:not([data-collapsed-summary]):not([data-virtual-spacer]):not([data-history-load]){cursor:default;transition:background-color .12s var(--ds-ease-in-out), opacity .12s var(--ds-ease-in-out);outline:none}.e4KDVa_table tbody tr[data-timeline-focus=outside]{opacity:.24}.e4KDVa_table tbody tr:not([data-collapsed-summary]):not([data-virtual-spacer]):not([data-history-load]):not([data-selected=true]):hover{background:var(--dsw-alias-interactive-bg-hover)}.e4KDVa_table tbody tr[data-request-only=true]:hover{background:0 0}.e4KDVa_table tbody tr[data-request-only=true] td{border-bottom:0;height:0;padding-top:0;padding-bottom:0}.e4KDVa_table tbody tr[data-terminal-request-boundary=true] td{height:9px}.e4KDVa_table tbody tr[data-request-only=true] .e4KDVa_turnRail{top:-15px;bottom:0}.e4KDVa_table tbody tr:not([data-collapsed-summary]):focus-visible{box-shadow:inset 0 0 0 1px var(--dsw-alias-state-business-primary)}.e4KDVa_table tbody tr[data-selected=true]{background:var(--dsw-alias-interactive-bg-active)}.e4KDVa_requestBoundaryControl{--request-boundary-base-left:12px;z-index:6;top:-8px;left:calc(var(--request-boundary-base-left) + var(--request-boundary-offset,0px));cursor:pointer;background:0 0;border:0;width:16px;height:16px;padding:0;position:absolute}.e4KDVa_requestBoundaryControl:before{background:var(--dsw-alias-label-caption);width:5px;height:5px;box-shadow:0 0 0 2px var(--dsw-alias-bg-layer-1), 0 0 0 3px transparent;content:\"\";transition:background .12s var(--ds-ease-in-out), box-shadow .12s var(--ds-ease-in-out);border-radius:50%;position:absolute;top:5.5px;left:5.5px}.e4KDVa_requestBoundaryControl:after{border:1px solid var(--dsw-alias-border-l1);width:max-content;color:var(--dsw-alias-label-secondary);background:var(--dsw-alias-bg-layer-1);content:attr(data-label);font:9px/12px var(--ds-font-family-code);opacity:0;pointer-events:none;transition:opacity .12s var(--ds-ease-in-out), transform .12s var(--ds-ease-in-out);user-select:none;white-space:nowrap;border-radius:2px;padding:0 4px;position:absolute;top:2px;left:17px;transform:translate(-2px);box-shadow:0 2px 6px #0000001f}.e4KDVa_requestBoundaryControl:hover:before,.e4KDVa_requestBoundaryControl:focus-visible:before{background:var(--dsw-alias-brand-primary-new-colorprimary-new-color)}.e4KDVa_requestBoundaryControlActive:before,.e4KDVa_requestBoundaryControlActive:hover:before,.e4KDVa_requestBoundaryControlActive:focus-visible:before{background:color-mix(in srgb, var(--dsw-alias-brand-primary-new-colorprimary-new-color) 18%, var(--dsw-alias-bg-layer-1));box-shadow:0 0 0 1.5px var(--dsw-alias-brand-primary-new-colorprimary-new-color)}.e4KDVa_requestBoundaryControl[data-request-status=error]:before,.e4KDVa_requestBoundaryControl[data-request-status=error]:hover:before,.e4KDVa_requestBoundaryControl[data-request-status=error]:focus-visible:before{background:var(--dsw-alias-state-error-primary)}.e4KDVa_requestBoundaryControl:hover:after,.e4KDVa_requestBoundaryControl:focus-visible:after{opacity:1;transform:translate(0)}.e4KDVa_requestBoundaryControl:focus-visible{outline:none}.e4KDVa_table tbody tr:has(.e4KDVa_requestBoundaryControl:hover):not([data-selected=true]){background:0 0}.e4KDVa_event{position:relative}.e4KDVa_turnRail,.e4KDVa_selectionRail{background:var(--dsw-alias-brand-primary-new-colorprimary-new-color);pointer-events:none;position:absolute;left:0}.e4KDVa_turnRail{z-index:4;background:var(--trajectory-turn-accent);width:2px;top:-1px;bottom:-1px}.e4KDVa_table tbody tr[data-turn-end=true] .e4KDVa_turnRail{bottom:0}.e4KDVa_selectionRail{z-index:5;width:3px;top:0;bottom:0}.e4KDVa_table tbody tr[data-error=true] .e4KDVa_turnRail{background:color-mix(in srgb, var(--dsw-alias-state-error-primary) 22%, var(--dsw-alias-bg-layer-1))}.e4KDVa_table tbody tr[data-error=true] .e4KDVa_selectionRail{background:var(--dsw-alias-state-error-primary)}.e4KDVa_table tbody tr[data-turn-start=true] td{position:relative;overflow:visible}.e4KDVa_table tbody tr[data-turn-start=true]:not(:first-child) td:before{z-index:1;background:var(--dsw-alias-border-l1);content:\"\";pointer-events:none;height:2px;position:absolute;top:0;left:0;right:0;transform:translateY(-50%)}.e4KDVa_event{padding-left:36px!important;padding-right:4px!important;overflow:visible!important}.e4KDVa_turnLabel{z-index:3;box-sizing:border-box;width:max-content;color:var(--dsw-alias-label-tertiary);background:var(--dsw-alias-bg-module-platform);font:8px/10px var(--ds-font-family-code);font-variant-numeric:tabular-nums;user-select:none;white-space:nowrap;border-radius:0 0 2px;flex:none;align-items:center;padding:1px 5px;display:inline-grid;position:absolute;top:0;left:0}.e4KDVa_turnLabelFull,.e4KDVa_turnLabelCompact{opacity:1;white-space:nowrap;grid-area:1/1;max-width:64px;overflow:hidden}.e4KDVa_turnLabelCompact{opacity:0;max-width:0}.e4KDVa_turnLabelActive{color:color-mix(in srgb, var(--dsw-static-blue-500) 55%, var(--dsw-alias-label-tertiary));background:var(--trajectory-turn-accent)}.e4KDVa_eventInner{justify-content:flex-start;align-items:center;min-width:0;height:100%;display:flex}.e4KDVa_kindSlot{flex:none;justify-content:flex-end;align-items:flex-end;width:76px;display:flex}.e4KDVa_kindSlot [role=tooltip]{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-2);box-shadow:var(--dsw-shadow-lv2);color:var(--dsw-alias-label-primary)}.e4KDVa_content{color:var(--dsw-alias-label-primary);padding-left:4px!important}.e4KDVa_kindTag{box-sizing:border-box;letter-spacing:.035em;user-select:none;border:1px solid #0000;border-radius:4px;flex:none;align-items:center;height:19px;padding:0 5px;font-size:10px;font-weight:650;line-height:16px;display:inline-flex}.e4KDVa_kindTagIcon{opacity:0;flex:none;justify-content:center;align-items:center;width:0;height:13px;display:inline-flex;overflow:hidden;transform:scale(.8)}.e4KDVa_kindTagLabel{opacity:1;white-space:nowrap;max-width:72px;display:inline-block;overflow:hidden}.e4KDVa_table .e4KDVa_kindSlot .e4KDVa_message{justify-content:center;width:100%}@container e4KDVa_trajectory-table (width<=620px){.e4KDVa_eventColumn{width:50px}.e4KDVa_event{padding-left:28px!important;padding-right:3px!important}.e4KDVa_requestBoundaryControl{--request-boundary-base-left:6px}.e4KDVa_kindSlot{width:19px}.e4KDVa_kindTag,.e4KDVa_table .e4KDVa_kindSlot .e4KDVa_message{justify-content:center;width:19px;padding-left:0;padding-right:0}.e4KDVa_kindTagIcon{opacity:1;width:13px;transform:scale(1)}.e4KDVa_kindTagLabel,.e4KDVa_turnLabelFull{opacity:0;max-width:0}.e4KDVa_turnLabelCompact{opacity:1;max-width:64px}}@media (prefers-reduced-motion:no-preference){.e4KDVa_eventColumn,.e4KDVa_event,.e4KDVa_requestBoundaryControl,.e4KDVa_kindSlot,.e4KDVa_kindTag,.e4KDVa_kindTagIcon,.e4KDVa_kindTagLabel,.e4KDVa_turnLabelFull,.e4KDVa_turnLabelCompact{transition-duration:.18s;transition-timing-function:var(--ds-ease-in-out)}.e4KDVa_eventColumn,.e4KDVa_kindSlot{transition-property:width}.e4KDVa_event{transition-property:padding-right,padding-left}.e4KDVa_requestBoundaryControl{transition-property:left}.e4KDVa_kindTag{transition-property:padding-right,padding-left}.e4KDVa_kindTagIcon{transition-property:width,opacity,transform}.e4KDVa_kindTagLabel,.e4KDVa_turnLabelFull,.e4KDVa_turnLabelCompact{transition-property:max-width,opacity}}.e4KDVa_user{color:var(--dsw-alias-state-business-primary);background:var(--dsw-alias-state-business-tertiary)}.e4KDVa_systemNeutral{color:var(--dsw-alias-label-secondary);background:var(--dsw-alias-bg-module-platform)}.e4KDVa_contextGreen{color:color-mix(in srgb, var(--dsw-alias-state-success-primary) 68%, var(--dsw-alias-label-secondary));background:var(--dsw-alias-state-success-tertiary)}.e4KDVa_compacted{color:var(--dsw-alias-label-secondary);background:var(--dsw-alias-bg-module-platform)}.e4KDVa_compactedSummary{font:var(--dsw-font-xs-13);margin-top:12px;padding:0 0 14px}.e4KDVa_promptDiffSections{flex-direction:column;gap:14px;max-height:100%;padding:10px 14px 14px;display:flex;overflow:auto}.e4KDVa_promptDiffSection{min-width:0}.e4KDVa_promptDiffTitle{color:var(--dsw-alias-label-secondary);font:var(--dsw-font-xs-strong-13);user-select:none;margin:0 0 6px}.e4KDVa_promptDiff{color:var(--dsw-alias-label-primary);background:var(--dsw-alias-bg-layer-1);font:11px/17px var(--ds-font-family-code);white-space:pre;margin:0;overflow:auto}.e4KDVa_promptDiff span{min-width:max-content;padding:0 6px;display:block}.e4KDVa_promptDiffLinemeta{color:var(--dsw-alias-label-caption);background:var(--dsw-alias-bg-module-platform);user-select:none}.e4KDVa_promptDiffLinecontext{color:var(--dsw-alias-label-secondary)}.e4KDVa_promptDiffLineadded{color:color-mix(in srgb, var(--dsw-alias-state-success-primary) 72%, var(--dsw-alias-label-primary));background:var(--dsw-alias-state-success-tertiary)}.e4KDVa_promptDiffLineremoved{color:var(--dsw-alias-state-error-primary);background:color-mix(in srgb, var(--dsw-alias-state-error-primary) 12%, var(--dsw-alias-bg-layer-1))}.e4KDVa_assistantVioletBright{color:color-mix(in srgb, var(--dsw-alias-brand-primary-new-colorprimary-new-color) 60%, var(--dsw-alias-state-error-secondary));background:color-mix(in srgb, color-mix(in srgb, var(--dsw-alias-brand-primary-new-colorprimary-new-color) 55%, var(--dsw-alias-state-error-secondary)) 15%, var(--dsw-alias-bg-layer-1))}.e4KDVa_toolAmber{color:var(--dsw-alias-state-warn-label);background:var(--dsw-alias-state-warn-tertiary)}.e4KDVa_subtoolAmber{color:color-mix(in srgb, var(--dsw-alias-state-warn-label) 62%, var(--dsw-alias-label-tertiary));background:color-mix(in srgb, var(--dsw-alias-state-warn-tertiary) 58%, var(--dsw-alias-bg-layer-1))}.e4KDVa_contentText{text-overflow:ellipsis;white-space:nowrap;min-width:0;display:block;overflow:hidden}.e4KDVa_toolCallOnly{color:var(--dsw-alias-label-tertiary)}.e4KDVa_table tbody tr[data-collapsed-summary=turn] td,.e4KDVa_table tbody tr[data-collapsed-summary=assistant] td{height:20px}.e4KDVa_table tbody tr[data-collapsed-summary]{cursor:pointer;transition:background-color .12s var(--ds-ease-in-out);outline:none}.e4KDVa_table tbody tr[data-collapsed-summary]:hover{background:var(--dsw-alias-interactive-bg-hover)}.e4KDVa_table tbody tr[data-collapsed-summary]:focus-visible{box-shadow:inset 0 0 0 1px var(--dsw-alias-state-business-primary)}.e4KDVa_collapsedTurnContent{min-width:0;color:var(--dsw-alias-label-secondary);align-items:center;font-size:12px;line-height:16px;display:flex}.e4KDVa_collapsedTurnEllipsis{color:var(--dsw-alias-label-tertiary);user-select:none;flex:none;margin-right:6px;font-weight:600}.e4KDVa_collapsedTurnText{text-overflow:ellipsis;white-space:nowrap;min-width:0;overflow:hidden}.e4KDVa_resultPreview{grid-template-columns:clamp(180px, var(--trajectory-tool-request-width,calc(36cqw - 56px)), 480px) minmax(0, 1fr);align-items:center;gap:8px;min-width:0;display:grid}.e4KDVa_resultRequest,.e4KDVa_inlineResultText{text-overflow:ellipsis;white-space:nowrap;min-width:0;overflow:hidden}.e4KDVa_toolCallNameTypeface{color:var(--dsw-alias-label-primary);font:400 12px/18px Menlo,Consolas,Liberation Mono,PingFang SC,Microsoft YaHei}.e4KDVa_toolCallPayload{color:var(--dsw-alias-label-secondary);font:400 12px/18px var(--ds-font-family-code);margin-left:7px}.e4KDVa_table tbody tr[data-kind=tool] .e4KDVa_contentText,.e4KDVa_table tbody tr[data-kind=subtool] .e4KDVa_contentText,.e4KDVa_table tbody tr[data-kind=tool] .e4KDVa_resultPreview,.e4KDVa_table tbody tr[data-kind=subtool] .e4KDVa_resultPreview{font-family:var(--ds-font-family-code);font-size:12px}.e4KDVa_table tbody tr[data-kind=subtool] .e4KDVa_content{padding-left:26px}.e4KDVa_inlineResult{min-width:0;color:var(--dsw-alias-label-secondary);align-items:center;display:flex}.e4KDVa_noOutputText{color:var(--dsw-alias-label-caption)}.e4KDVa_arrow{color:var(--dsw-alias-label-caption);flex:none;margin-right:8px}.e4KDVa_error,.e4KDVa_overview dd.e4KDVa_error,.e4KDVa_details .e4KDVa_errorPayload{color:var(--dsw-alias-state-error-primary)}.e4KDVa_details .e4KDVa_errorPayload .e4KDVa_resultBlockText{color:inherit}.e4KDVa_details .e4KDVa_jsonPayload.e4KDVa_errorPayload,.e4KDVa_details .e4KDVa_jsonPreview.e4KDVa_errorPayload{--json-tree-property:var(--dsw-alias-state-error-primary);--json-tree-string:var(--dsw-alias-state-error-primary);--json-tree-number:var(--dsw-alias-state-error-primary);--json-tree-keyword:var(--dsw-alias-state-error-primary);--json-tree-punctuation:var(--dsw-alias-state-error-primary);--json-tree-icon:var(--dsw-alias-state-error-primary)}.e4KDVa_details{border-left:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-1);flex-direction:column;flex:none;width:clamp(320px,38%,440px);min-width:0;max-width:calc(100% - 280px);min-height:0;display:flex;position:relative}.e4KDVa_detailsResizeHandle{z-index:6;cursor:col-resize;touch-action:none;user-select:none;background:0 0;border:0;width:8px;padding:0;position:absolute;top:0;bottom:0;left:-4px}.e4KDVa_detailsResizeHandle:focus-visible{outline:none}.e4KDVa_detailsHeader{box-sizing:border-box;border-bottom:1px solid var(--dsw-alias-border-l2);flex:none;justify-content:space-between;align-items:center;height:42px;padding:0 8px 0 12px;display:flex}.e4KDVa_detailsTitle{min-width:0;color:var(--dsw-alias-label-primary);align-items:center;gap:8px;display:flex}.e4KDVa_requestDetailsDot{background:var(--dsw-alias-label-secondary);border-radius:50%;flex:none;width:5px;height:5px}.e4KDVa_requestDetailsName{font:500 12px/16px var(--ds-font-family-code);flex:none}.e4KDVa_detailsLocation{min-width:0;color:var(--dsw-alias-label-tertiary);font:11px/16px var(--ds-font-family-code);text-overflow:ellipsis;white-space:nowrap;overflow:hidden}.e4KDVa_close{width:28px;height:28px;color:var(--dsw-alias-label-secondary);cursor:pointer;background:0 0;border:0;border-radius:6px;flex:none;justify-content:center;align-items:center;padding:0;font-size:18px;line-height:18px;display:inline-flex}.e4KDVa_close:hover{color:var(--dsw-alias-label-primary);background:var(--dsw-alias-interactive-bg-hover)}.e4KDVa_detailTabs{box-sizing:border-box;border-bottom:1px solid var(--dsw-alias-border-l2);overscroll-behavior-x:contain;scrollbar-width:none;white-space:nowrap;flex:none;gap:1px;width:100%;min-width:0;max-width:100%;height:34px;padding:0 8px;display:flex;overflow:auto hidden}.e4KDVa_detailTabs::-webkit-scrollbar{display:none}.e4KDVa_detailTab{color:var(--dsw-alias-label-tertiary);cursor:pointer;font:var(--dsw-font-xs-13);background:0 0;border:0;flex:none;padding:0 9px;position:relative}.e4KDVa_detailTab:hover{color:var(--dsw-alias-label-primary);background:var(--dsw-alias-interactive-bg-hover)}.e4KDVa_detailTabActive{color:var(--dsw-alias-state-business-primary)}.e4KDVa_detailTabActive:after{background:var(--dsw-alias-state-business-primary);content:\"\";border-radius:1px 1px 0 0;height:2px;position:absolute;bottom:0;left:9px;right:9px}.e4KDVa_close:focus-visible,.e4KDVa_detailTab:focus-visible{outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:-1px}.e4KDVa_detailBody{min-height:0;padding-bottom:var(--dsh-trajectory-bottom-clearance,0px);scrollbar-gutter:stable;flex:1;overflow:hidden auto}.e4KDVa_detailBodySummary{box-sizing:border-box;padding-bottom:calc(12px + var(--dsh-trajectory-bottom-clearance,0px));flex-direction:column;display:flex;overflow:hidden}.e4KDVa_detailBodySummary>.e4KDVa_overview{overscroll-behavior:contain;flex:0 auto;min-height:0;overflow:auto}.e4KDVa_detailBodySummary>.e4KDVa_compactedSummary{flex:1;min-height:0;overflow:auto}.e4KDVa_summaryScrollRegion{--dsh-scrollbar-thumb:transparent;--dsh-scrollbar-thumb-hover:transparent}.e4KDVa_summaryScrollRegion:hover,.e4KDVa_summaryScrollRegion:focus-within{--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2)}.e4KDVa_compactedSummary .e4KDVa_markdownPayload{padding-right:18px}.e4KDVa_overview{font:var(--dsw-font-xs-13);margin:0;padding:8px 0}.e4KDVa_overviewParentLinks{gap:14px;display:flex}.e4KDVa_overviewHierarchyNavLink{all:unset;color:var(--dsw-alias-label-secondary);cursor:pointer;font:inherit;opacity:1;align-items:center;gap:1px;display:inline-flex}.e4KDVa_overviewHierarchyNavLink:hover{color:var(--dsw-alias-label-primary)}.e4KDVa_overviewHierarchyJumpIconTight{color:var(--dsw-alias-label-caption);flex:none}.e4KDVa_overviewHierarchyNavLink:hover .e4KDVa_overviewHierarchyJumpIconTight,.e4KDVa_overviewHierarchyNavLink:focus-visible .e4KDVa_overviewHierarchyJumpIconTight{color:var(--dsw-alias-label-primary)}.e4KDVa_overviewHierarchyNavLink:focus-visible{color:var(--dsw-alias-label-primary);outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:2px}.e4KDVa_overview>div{grid-template-columns:94px minmax(0,1fr);align-items:center;min-height:22px;padding:0 14px;display:grid}.e4KDVa_overview>.e4KDVa_requestTokenDetail dt{padding-left:12px}.e4KDVa_usagePanel{padding:4px 0 10px}.e4KDVa_usageGroup+.e4KDVa_usageGroup{margin-top:8px}.e4KDVa_usageHeading{color:var(--dsw-alias-label-secondary);font:var(--dsw-font-xs-strong-13);user-select:none;margin:0;padding:4px 14px 1px}.e4KDVa_usageGroup .e4KDVa_overview{padding:0}.e4KDVa_overview dt{color:var(--dsw-alias-label-tertiary)}.e4KDVa_overview dd{min-width:0;color:var(--dsw-alias-label-primary);text-overflow:ellipsis;white-space:nowrap;margin:0;overflow:hidden}.e4KDVa_timestampToggle{all:unset;color:inherit;cursor:pointer;font:inherit;user-select:text}.e4KDVa_timestampToggle:focus-visible{outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:2px}.e4KDVa_overviewSections{border-top:0;flex-direction:column;flex:1;min-height:min-content;display:flex;overflow:hidden}.e4KDVa_overviewSection{flex-direction:column;flex:1 1 0;min-height:28px;max-height:max-content;display:flex;overflow:hidden}.e4KDVa_overviewSection+.e4KDVa_overviewSection{padding-top:8px}.e4KDVa_overviewHeading{box-sizing:border-box;width:100%;height:28px;color:var(--dsw-alias-label-secondary);background:var(--dsw-alias-bg-layer-1);font:var(--dsw-font-xs-strong-13);user-select:none;flex:none;align-items:flex-end;margin:0;padding:0 0 3px 14px;display:flex}.e4KDVa_overviewTitle{width:max-content;height:auto;color:inherit;cursor:pointer;font:inherit;user-select:none;background:0 0;border:0;flex:none;align-items:center;gap:3px;padding:0;line-height:1;display:inline-flex}.e4KDVa_overviewTitleIcon{color:var(--dsw-alias-label-caption);flex:none}.e4KDVa_overviewTitle:hover .e4KDVa_overviewTitleIcon{color:var(--dsw-alias-label-primary)}.e4KDVa_overviewTitle:focus-visible{outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:2px}.e4KDVa_overviewTitle:focus-visible .e4KDVa_overviewTitleIcon{color:var(--dsw-alias-state-business-primary)}.e4KDVa_overviewPreview{overscroll-behavior:contain;background:var(--dsw-alias-bg-layer-1);flex:1;min-height:0;overflow:auto}.e4KDVa_overviewPreview>:last-child{margin-bottom:0;padding-bottom:0}.e4KDVa_overviewPreview .e4KDVa_jsonPreview>:first-child,.e4KDVa_overviewPreview .e4KDVa_schemaTree>:first-child{padding-bottom:0}.e4KDVa_overviewPreview .e4KDVa_schemaTree{margin-bottom:0}.e4KDVa_overviewPreview .e4KDVa_overview{padding:2px 0 0}.e4KDVa_overviewPreview .e4KDVa_overview>div{min-height:22px}.e4KDVa_markdownPreview,.e4KDVa_markdownPayload{color:var(--dsw-alias-label-primary)}.e4KDVa_markdownPreview>div,.e4KDVa_markdownPayload>div{font:var(--dsw-font-xs-13);gap:8px}.e4KDVa_markdownPreview>div h1,.e4KDVa_markdownPayload>div h1{font:600 16px/22px var(--dsw-font-family)}.e4KDVa_markdownPreview>div h2,.e4KDVa_markdownPayload>div h2{font:600 15px/22px var(--dsw-font-family)}.e4KDVa_markdownPreview>div :where(h3,h4,h5,h6),.e4KDVa_markdownPayload>div :where(h3,h4,h5,h6){font:600 14px/20px var(--dsw-font-family)}.e4KDVa_markdownPreview>div :not(pre)>code,.e4KDVa_markdownPayload>div :not(pre)>code{font:12px/18px var(--ds-font-family-code)}.e4KDVa_markdownPreview>div table,.e4KDVa_markdownPayload>div table{font:var(--dsw-font-xs-13)}.e4KDVa_markdownPreview>div>:first-child{margin-top:0}.e4KDVa_markdownPreview>div>:last-child{margin-bottom:0}.e4KDVa_markdownPreview>div :where(h1,h2,h3){margin:12px 0 6px}.e4KDVa_markdownPreview>div :where(h4,h5,h6){margin:10px 0 5px}.e4KDVa_markdownPreview>div :where(p,ul,ol){margin:8px 0}.e4KDVa_markdownPreview>div li:not(:first-child){margin-top:3px}.e4KDVa_markdownPreview>div blockquote{margin-top:8px}.e4KDVa_markdownPreview>div hr{margin:14px 0}.e4KDVa_markdownPreview>div>.md-code-block{margin:10px 0}.e4KDVa_assistantContent .e4KDVa_markdownPayload,.e4KDVa_assistantContent .e4KDVa_payload{min-height:0}.e4KDVa_thinkingQuote{border-left:2px solid var(--dsw-alias-markdown-citation);color:var(--dsw-alias-label-secondary);background:0 0;margin:6px 14px 0 12px;padding-left:6px}.e4KDVa_thinkingQuoteOnlyPreview{margin-bottom:8px}.e4KDVa_detailBody>.e4KDVa_assistantContentRendered .e4KDVa_thinkingQuote{margin-top:14px}.e4KDVa_thinkingToggle{width:max-content;height:18px;color:var(--dsw-alias-label-tertiary);cursor:pointer;font:600 12px/18px var(--dsw-font-family);user-select:none;background:0 0;border:0;align-items:center;gap:2px;padding:0;display:flex}.e4KDVa_thinkingChevron{transition:transform .12s var(--ds-ease-in-out);flex:none}.e4KDVa_thinkingToggle[aria-expanded=true] .e4KDVa_thinkingChevron{transform:rotate(90deg)}.e4KDVa_thinkingToggle:hover{color:var(--dsw-alias-label-secondary)}.e4KDVa_thinkingToggle:focus-visible{outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:2px}.e4KDVa_thinkingQuote .e4KDVa_markdownPreview,.e4KDVa_thinkingQuote .e4KDVa_markdownPayload,.e4KDVa_thinkingQuote .e4KDVa_payload{min-height:0;color:var(--dsw-alias-label-secondary);background:0 0;padding:2px 0}.e4KDVa_assistantOutput{background:var(--dsw-alias-bg-layer-1)}.e4KDVa_markdownPreview{padding:6px 14px 8px}.e4KDVa_markdownPayload{min-height:100%;padding:14px}.e4KDVa_jsonPayload{min-height:100%}.e4KDVa_jsonPreview{min-height:0}.e4KDVa_schema{background:var(--dsw-alias-bg-layer-1);min-height:100%}.e4KDVa_schemaPreview{min-height:0}.e4KDVa_schemaIntro{padding:12px 14px 6px}.e4KDVa_schemaPreview .e4KDVa_schemaIntro{padding-top:6px}.e4KDVa_schemaName{color:var(--dsw-alias-label-primary);font:600 12px/18px var(--ds-font-family-code);margin:0}.e4KDVa_schemaDescription{color:var(--dsw-alias-label-secondary);font:var(--dsw-font-xs-13);white-space:pre-wrap;margin:2px 0 0}.e4KDVa_schemaParameters{min-width:0}.e4KDVa_schemaParametersTitle{color:var(--dsw-alias-label-tertiary);font:600 11px/16px var(--dsw-font-family);user-select:none;margin:0;padding:4px 14px 2px}.e4KDVa_schemaTree{margin:0 6px 8px 0}.e4KDVa_payload{box-sizing:border-box;overflow-wrap:anywhere;min-height:100%;color:var(--dsw-alias-label-primary);background:var(--dsw-alias-markdown-code-block);font:12px/19px var(--ds-font-family-code);tab-size:2;white-space:pre-wrap;margin:0;padding:14px}.e4KDVa_payloadPreview{min-height:0;padding:6px 14px 8px}.e4KDVa_sourceBlocks{box-sizing:border-box;min-height:100%;padding:12px 14px}.e4KDVa_sourceBlock+.e4KDVa_sourceBlock{margin-top:14px}.e4KDVa_sourceBlockHeader,.e4KDVa_sourceBlockJumpTarget{user-select:none;align-items:center;gap:3px;width:max-content;margin-bottom:3px;display:flex}.e4KDVa_sourceBlockJumpTarget{all:unset;cursor:pointer;user-select:none;align-items:center;gap:3px;width:max-content;margin-bottom:3px;display:flex}.e4KDVa_sourceBlockLabel{color:var(--dsw-alias-label-tertiary);font:11px/16px var(--ds-font-family-code)}.e4KDVa_sourceBlockJumpIcon{color:var(--dsw-alias-label-caption);flex:none}.e4KDVa_sourceBlockJumpTarget:hover .e4KDVa_sourceBlockJumpIcon{color:var(--dsw-alias-label-primary)}.e4KDVa_sourceBlockJumpTarget:focus-visible{outline:none}.e4KDVa_sourceBlockJumpTarget:focus-visible .e4KDVa_sourceBlockJumpIcon{color:var(--dsw-alias-state-business-primary)}.e4KDVa_sourceBlockContent{overflow-wrap:anywhere;color:var(--dsw-alias-label-primary);font:12px/19px var(--ds-font-family-code);tab-size:2;white-space:pre-wrap;background:0 0;margin:0}.e4KDVa_panelImageLink{cursor:zoom-in;border-radius:4px;width:auto;max-width:100%;display:block;overflow:hidden}.e4KDVa_panelImageLinkPreview{max-height:140px}.e4KDVa_panelImage{border-radius:inherit;background:var(--dsw-alias-bg-base);object-fit:contain;width:auto;max-width:100%;height:auto;max-height:320px;margin:0;display:block}.e4KDVa_panelImageLinkPreview .e4KDVa_panelImage{max-height:140px}.e4KDVa_messageImages{flex-direction:column;gap:8px;margin:8px 14px 14px;display:flex}.e4KDVa_messageImagesPreview{gap:6px;margin:6px 14px 8px}.e4KDVa_assistantToolCalls{box-sizing:border-box;max-width:100%;color:var(--dsw-alias-label-secondary);font:11px/17px var(--ds-font-family-code);margin:2px 14px 12px;padding:0;list-style:none}.e4KDVa_assistantToolCallsPreview{margin-top:2px;margin-bottom:8px}.e4KDVa_assistantToolCalls li{min-width:0}.e4KDVa_assistantToolCallButton{all:unset;box-sizing:border-box;cursor:pointer;border-radius:3px;align-items:center;width:calc(100% + 4px);min-width:0;height:19px;margin-left:-4px;padding:0 4px;display:flex}.e4KDVa_assistantToolCallButton:hover{background:var(--dsw-alias-interactive-bg-hover)}.e4KDVa_assistantToolCallButton:focus-visible{background:var(--dsw-alias-interactive-bg-hover);outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:-1px}.e4KDVa_assistantToolCallIcon{color:var(--dsw-alias-label-caption);flex:none;margin-right:5px}.e4KDVa_assistantToolCallButton:hover .e4KDVa_assistantToolCallIcon,.e4KDVa_assistantToolCallButton:focus-visible .e4KDVa_assistantToolCallIcon{color:var(--dsw-alias-label-secondary)}.e4KDVa_assistantToolCallText{white-space:nowrap;flex:1;min-width:0;display:flex;overflow:hidden}.e4KDVa_assistantToolCallName{color:var(--dsw-alias-label-secondary);flex:none;margin-right:5px;font-weight:500}.e4KDVa_assistantToolCallArgs{min-width:0;color:var(--dsw-alias-label-tertiary);text-overflow:ellipsis;white-space:nowrap;overflow:hidden}.e4KDVa_systemPrompt{box-sizing:border-box}.e4KDVa_toolCatalog{min-height:100%;padding:8px 0 16px}.e4KDVa_toolCatalogItem{border-bottom:1px solid var(--dsw-alias-border-l1)}.e4KDVa_toolCatalogSummary{box-sizing:border-box;cursor:pointer;user-select:none;grid-template-columns:12px 12px max-content minmax(0,1fr);align-items:center;gap:5px;min-height:30px;padding:4px 12px;list-style:none;display:grid}.e4KDVa_toolCatalogSummary::-webkit-details-marker{display:none}.e4KDVa_toolCatalogSummary:hover{background:var(--dsw-alias-interactive-bg-hover)}.e4KDVa_toolCatalogSummary:focus-visible{background:var(--dsw-alias-interactive-bg-hover);outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:-1px}.e4KDVa_toolCatalogChevron,.e4KDVa_toolCatalogIcon{color:var(--dsw-alias-label-caption)}.e4KDVa_toolCatalogChevron{transition:transform .1s var(--ds-ease-in-out)}.e4KDVa_toolCatalogItem[open] .e4KDVa_toolCatalogChevron{transform:rotate(90deg)}.e4KDVa_toolCatalogName{color:var(--dsw-alias-label-primary);font:500 12px/18px var(--ds-font-family-code)}.e4KDVa_toolCatalogDescription{min-width:0;color:var(--dsw-alias-label-tertiary);font:var(--dsw-font-xs-13);text-overflow:ellipsis;white-space:nowrap;overflow:hidden}.e4KDVa_toolCatalogDefinition{background:var(--dsw-alias-bg-base);padding:0 0 8px 29px}.e4KDVa_toolCatalogFullDescription{color:var(--dsw-alias-label-secondary);font:var(--dsw-font-xs-13);white-space:pre-wrap;margin:0;padding:7px 14px 4px 0}.e4KDVa_toolCatalogTree{margin-left:-14px;margin-right:6px}.e4KDVa_resultBlocks{box-sizing:border-box;flex-direction:column;gap:10px;min-height:100%;padding:14px;display:flex}.e4KDVa_resultBlocksPreview{gap:6px;min-height:0;padding:6px 14px 8px}.e4KDVa_resultBlockText{overflow-wrap:anywhere;color:var(--dsw-alias-label-primary);font:12px/19px var(--ds-font-family-code);tab-size:2;white-space:pre-wrap;background:0 0;margin:0}.e4KDVa_overviewPreview .e4KDVa_noPayload{padding:6px 14px 8px}.e4KDVa_noPayload{color:var(--dsw-alias-label-tertiary);font:var(--dsw-font-xs-13);margin:0;padding:18px 14px}@media (width<=760px){.e4KDVa_details{z-index:5;border-left-color:var(--dsw-alias-border-l3);width:min(92%,420px);max-width:92%;position:absolute;top:0;bottom:0;right:0;box-shadow:-12px 0 32px #00000024}}";
		...
		var TrajectoryTable_module_css_default = {
			"compacted": "e4KDVa_compacted",
			"user": "e4KDVa_user",
			"requestDetailsDot": "e4KDVa_requestDetailsDot",
			"detailBodySummary": "e4KDVa_detailBodySummary",
			"toolCallOnly": "e4KDVa_toolCallOnly",
			"overview": "e4KDVa_overview",
			"toolCatalog": "e4KDVa_toolCatalog",
			"detailTabActive": "e4KDVa_detailTabActive",
			"toolCatalogItem": "e4KDVa_toolCatalogItem",
			"promptDiffSections": "e4KDVa_promptDiffSections",
			"kindSlot": "e4KDVa_kindSlot",
			"assistantToolCallIcon": "e4KDVa_assistantToolCallIcon",
			"noPayload": "e4KDVa_noPayload",
			"content": "e4KDVa_content",
			"collapsedTurnText": "e4KDVa_collapsedTurnText",
			"promptDiffTitle": "e4KDVa_promptDiffTitle",
			"overviewPreview": "e4KDVa_overviewPreview",
			"toolCatalogChevron": "e4KDVa_toolCatalogChevron",
			"detailBody": "e4KDVa_detailBody",
			"compactedSummary": "e4KDVa_compactedSummary",
			"systemNeutral": "e4KDVa_systemNeutral",
			"detailsTitle": "e4KDVa_detailsTitle",
			"turnRail": "e4KDVa_turnRail",
			"subtoolAmber": "e4KDVa_subtoolAmber",
			"markdownPreview": "e4KDVa_markdownPreview",
			"schemaName": "e4KDVa_schemaName",
			"panelImageLink": "e4KDVa_panelImageLink",
			"assistantToolCallArgs": "e4KDVa_assistantToolCallArgs",
			"resultBlocks": "e4KDVa_resultBlocks",
			"message": "e4KDVa_message",
			"markdownPayload": "e4KDVa_markdownPayload",
			"detailTab": "e4KDVa_detailTab",
			"jsonPreview": "e4KDVa_jsonPreview",
			"timestampToggle": "e4KDVa_timestampToggle",
			"thinkingQuoteOnlyPreview": "e4KDVa_thinkingQuoteOnlyPreview",
			"toolCatalogDefinition": "e4KDVa_toolCatalogDefinition",
			"resultBlockText": "e4KDVa_resultBlockText",
			"overviewHeading": "e4KDVa_overviewHeading",
			"turnLabelCompact": "e4KDVa_turnLabelCompact",
			"arrow": "e4KDVa_arrow",
			"promptDiffLinecontext": "e4KDVa_promptDiffLinecontext",
			"assistantContentRendered": "e4KDVa_assistantContentRendered",
			"toolCatalogDescription": "e4KDVa_toolCatalogDescription",
			"eventColumn": "e4KDVa_eventColumn",
			"detailsLocation": "e4KDVa_detailsLocation",
			"resultPreview": "e4KDVa_resultPreview",
			"sourceBlockContent": "e4KDVa_sourceBlockContent",
			"requestDetailsName": "e4KDVa_requestDetailsName",
			"summaryScrollRegion": "e4KDVa_summaryScrollRegion",
			"thinkingChevron": "e4KDVa_thinkingChevron",
			"overviewSections": "e4KDVa_overviewSections",
			"kindTag": "e4KDVa_kindTag",
			"promptDiff": "e4KDVa_promptDiff",
			"promptDiffLineremoved": "e4KDVa_promptDiffLineremoved",
			"resultRequest": "e4KDVa_resultRequest",
			"requestTokenDetail": "e4KDVa_requestTokenDetail",
			"inlineResult": "e4KDVa_inlineResult",
			"thinkingQuote": "e4KDVa_thinkingQuote",
			"schemaIntro": "e4KDVa_schemaIntro",
			"panelImage": "e4KDVa_panelImage",
			"toolCatalogSummary": "e4KDVa_toolCatalogSummary",
			"historyLoadingSpinner": "e4KDVa_historyLoadingSpinner",
			"sourceBlockLabel": "e4KDVa_sourceBlockLabel",
			"messageImagesPreview": "e4KDVa_messageImagesPreview",
			"usagePanel": "e4KDVa_usagePanel",
			"toolCallPayload": "e4KDVa_toolCallPayload",
			"panelImageLinkPreview": "e4KDVa_panelImageLinkPreview",
			"kindTagLabel": "e4KDVa_kindTagLabel",
			"toolCatalogFullDescription": "e4KDVa_toolCatalogFullDescription",
			"virtualSpacer": "e4KDVa_virtualSpacer",
			"eventHeader": "e4KDVa_eventHeader",
			"usageGroup": "e4KDVa_usageGroup",
			"collapsedTurnContent": "e4KDVa_collapsedTurnContent",
			"schema": "e4KDVa_schema",
			"detailsResizeHandle": "e4KDVa_detailsResizeHandle",
			"usageHeading": "e4KDVa_usageHeading",
			"schemaPreview": "e4KDVa_schemaPreview",
			"payloadPreview": "e4KDVa_payloadPreview",
			"assistantToolCallButton": "e4KDVa_assistantToolCallButton",
			"close": "e4KDVa_close",
			"overviewTitle": "e4KDVa_overviewTitle",
			"sourceBlockHeader": "e4KDVa_sourceBlockHeader",
			"table": "e4KDVa_table",
			"contextGreen": "e4KDVa_contextGreen",
			"turnLabelFull": "e4KDVa_turnLabelFull",
			"requestBoundaryControl": "e4KDVa_requestBoundaryControl",
			"resultBlocksPreview": "e4KDVa_resultBlocksPreview",
			"promptDiffLinemeta": "e4KDVa_promptDiffLinemeta",
			"assistantOutput": "e4KDVa_assistantOutput",
			"trajectory-table": "e4KDVa_trajectory-table",
			"messageImages": "e4KDVa_messageImages",
			"sourceBlocks": "e4KDVa_sourceBlocks",
			"historyLoadButton": "e4KDVa_historyLoadButton",
			"historyLoadingBar": "e4KDVa_historyLoadingBar",
			"sourceBlockJumpIcon": "e4KDVa_sourceBlockJumpIcon",
			"requestBoundaryControlActive": "e4KDVa_requestBoundaryControlActive",
			"toolCallNameTypeface": "e4KDVa_toolCallNameTypeface",
			"assistantToolCallsPreview": "e4KDVa_assistantToolCallsPreview",
			"assistantToolCallName": "e4KDVa_assistantToolCallName",
			"toolCatalogName": "e4KDVa_toolCatalogName",
			"assistantToolCalls": "e4KDVa_assistantToolCalls",
			"toolAmber": "e4KDVa_toolAmber",
			"promptDiffSection": "e4KDVa_promptDiffSection",
			"schemaParameters": "e4KDVa_schemaParameters",
			"contentColumn": "e4KDVa_contentColumn",
			"schemaDescription": "e4KDVa_schemaDescription",
			"overviewParentLinks": "e4KDVa_overviewParentLinks",
			"historyLoading": "e4KDVa_historyLoading",
			"visuallyHidden": "e4KDVa_visuallyHidden",
			"error": "e4KDVa_error",
			"details": "e4KDVa_details",
			"overviewHierarchyJumpIconTight": "e4KDVa_overviewHierarchyJumpIconTight",
			"eventInner": "e4KDVa_eventInner",
			"selectionRail": "e4KDVa_selectionRail",
			"turnLabel": "e4KDVa_turnLabel",
			"toolCatalogIcon": "e4KDVa_toolCatalogIcon",
			"split": "e4KDVa_split",
			"jsonPayload": "e4KDVa_jsonPayload",
			"assistantVioletBright": "e4KDVa_assistantVioletBright",
			"inlineResultText": "e4KDVa_inlineResultText",
			"event": "e4KDVa_event",
			"historyLoadRow": "e4KDVa_historyLoadRow",
			"schemaTree": "e4KDVa_schemaTree",
			"systemPrompt": "e4KDVa_systemPrompt",
			"detailTabs": "e4KDVa_detailTabs",
			"overviewTitleIcon": "e4KDVa_overviewTitleIcon",
			"detailsHeader": "e4KDVa_detailsHeader",
			"kindTagIcon": "e4KDVa_kindTagIcon",
			"assistantToolCallText": "e4KDVa_assistantToolCallText",
			"overviewSection": "e4KDVa_overviewSection",
			"history-loading-spin": "e4KDVa_history-loading-spin",
			"errorPayload": "e4KDVa_errorPayload",
			"overviewHierarchyNavLink": "e4KDVa_overviewHierarchyNavLink",
			"promptDiffLineadded": "e4KDVa_promptDiffLineadded",
			"payload": "e4KDVa_payload",
			"sourceBlockJumpTarget": "e4KDVa_sourceBlockJumpTarget",
			"thinkingToggle": "e4KDVa_thinkingToggle",
			"tablePane": "e4KDVa_tablePane",
			"assistantContent": "e4KDVa_assistantContent",
			"contentText": "e4KDVa_contentText",
			"schemaParametersTitle": "e4KDVa_schemaParametersTitle",
			"turnLabelActive": "e4KDVa_turnLabelActive",
			"collapsedTurnEllipsis": "e4KDVa_collapsedTurnEllipsis",
			"sourceBlock": "e4KDVa_sourceBlock",
			"noOutputText": "e4KDVa_noOutputText",
			"toolCatalogTree": "e4KDVa_toolCatalogTree"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:D:\tool\deepseek-harness\packages\client\ui-trajectory\src\client\TrajectoryToolbar.module.css.mjs
		const css$2 = ".nmhzWa_root{z-index:4;box-sizing:border-box;width:100%;height:var(--dsh-trajectory-toolbar-height);border-bottom:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-1);position:sticky;top:0}.nmhzWa_inner{box-sizing:border-box;align-items:center;gap:8px;width:100%;height:100%;padding:0 6px;display:flex}.nmhzWa_actions{flex:none;align-items:center;gap:2px;display:flex}.nmhzWa_toggle{height:20px;color:var(--dsw-alias-label-tertiary);cursor:pointer;font:var(--dsw-font-xxs-12);background:0 0;border:0;border-radius:3px;flex:none;align-items:center;gap:4px;padding:0 7px;display:inline-flex}.nmhzWa_toggle:hover,.nmhzWa_toggle[aria-pressed=true]{color:var(--dsw-alias-label-primary);background:var(--dsw-alias-interactive-bg-hover)}.nmhzWa_toggle:focus-visible{outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:1px}.nmhzWa_toggleIcon{stroke:currentColor;stroke-width:1.25px;stroke-linecap:round;stroke-linejoin:round;flex:none;width:12px;height:12px}.nmhzWa_control{box-sizing:border-box;width:88px;height:20px;color:var(--dsw-alias-label-tertiary);cursor:pointer;font:var(--dsw-font-xxs-12);background:0 0;border:0;border-radius:0;flex:none;justify-content:center;align-items:center;gap:4px;padding:0 5px;display:inline-flex}.nmhzWa_control[hidden]{display:none}.nmhzWa_control:hover:not(:disabled),.nmhzWa_control[aria-checked=true],.nmhzWa_control[aria-pressed=true]{color:var(--dsw-alias-label-primary)}.nmhzWa_control:focus-visible{outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:1px}.nmhzWa_control:disabled{color:var(--dsw-alias-label-dimmed);cursor:not-allowed}.nmhzWa_controlTrack{background:var(--dsw-alias-border-l2);width:20px;height:10px;transition:background-color .12s var(--ds-ease-in-out);border-radius:5px;flex:none;display:inline-block;position:relative}.nmhzWa_controlThumb{background:var(--dsw-alias-bg-layer-1);width:6px;height:6px;transition:transform .12s var(--ds-ease-in-out);border-radius:50%;position:absolute;top:2px;left:2px}.nmhzWa_controlTrack[data-on=true]{background:var(--dsw-alias-state-business-primary)}.nmhzWa_controlTrack[data-on=true] .nmhzWa_controlThumb{transform:translate(10px)}.nmhzWa_action{height:20px;color:var(--dsw-alias-label-tertiary);cursor:pointer;font:var(--dsw-font-xxs-12);background:0 0;border:0;border-radius:3px;flex:none;align-items:center;gap:4px;padding:0 5px;display:inline-flex}.nmhzWa_action:hover{color:var(--dsw-alias-label-primary);background:var(--dsw-alias-interactive-bg-hover)}.nmhzWa_action:focus-visible{outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:1px}.nmhzWa_actionIcon{color:var(--dsw-alias-label-tertiary);font:14px/14px var(--ds-font-family-code)}.nmhzWa_search{border:1px solid var(--dsw-alias-border-l2);min-width:84px;height:22px;color:var(--dsw-alias-label-caption);background:var(--dsw-alias-bg-layer-2);border-radius:4px;flex:0 164px;align-items:center;gap:4px;margin-left:auto;padding:0 6px;display:flex}.nmhzWa_search:hover{border-color:var(--dsw-alias-label-caption)}.nmhzWa_search:focus-within{border-color:var(--dsw-alias-state-business-primary);background:var(--dsw-alias-bg-layer-1)}.nmhzWa_searchIcon{flex:none}.nmhzWa_searchInput{width:100%;min-width:0;color:var(--dsw-alias-label-primary);font:var(--dsw-font-xxs-12);background:0 0;border:0;outline:0;padding:0}.nmhzWa_searchInput::placeholder{color:var(--dsw-alias-label-caption)}.nmhzWa_searchInput::-webkit-search-cancel-button{cursor:pointer;width:12px;height:12px}";
		...
		var TrajectoryToolbar_module_css_default = {
			"control": "nmhzWa_control",
			"toggle": "nmhzWa_toggle",
			"root": "nmhzWa_root",
			"controlTrack": "nmhzWa_controlTrack",
			"controlThumb": "nmhzWa_controlThumb",
			"actions": "nmhzWa_actions",
			"toggleIcon": "nmhzWa_toggleIcon",
			"actionIcon": "nmhzWa_actionIcon",
			"action": "nmhzWa_action",
			"inner": "nmhzWa_inner",
			"searchIcon": "nmhzWa_searchIcon",
			"search": "nmhzWa_search",
			"searchInput": "nmhzWa_searchInput"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:D:\tool\deepseek-harness\packages\client\ui-trajectory\src\client\TrajectoryTimeline.module.css.mjs
		const css$1 = ".G_fTGq_root{z-index:1;isolation:isolate;border-bottom:1px solid var(--dsw-alias-border-l2);user-select:none;flex:none;position:relative}.G_fTGq_root [role=tooltip]{font:var(--dsw-font-xxxs-11)}.G_fTGq_plot{background:var(--dsw-alias-bg-layer-2);grid-template-columns:44px minmax(0,1fr);height:50px;display:grid;overflow:hidden}.G_fTGq_labels{border-right:1px solid var(--dsw-alias-border-l1);color:var(--dsw-alias-label-caption);font:var(--dsw-font-xs-13);font-size:10px;line-height:1;position:relative}.G_fTGq_labels span{text-align:right;justify-content:flex-end;align-items:center;height:8px;display:flex;position:absolute;right:3px}.G_fTGq_labels span:first-child{top:7px}.G_fTGq_labels span:nth-child(2){top:21px}.G_fTGq_labels span:nth-child(3){top:35px}.G_fTGq_track{cursor:crosshair;touch-action:none;position:relative;overflow:hidden}.G_fTGq_track[data-panning=true]{cursor:grabbing}.G_fTGq_earlierHistory{z-index:5;appearance:none;box-sizing:border-box;background:linear-gradient(to right, var(--dsw-alias-bg-layer-2) 0, var(--dsw-alias-bg-layer-2) 38%, transparent 100%);width:28px;color:var(--dsw-alias-label-secondary);font:var(--dsw-font-xs-13);opacity:.72;cursor:pointer;border:0;outline:none;justify-content:flex-start;align-items:center;padding-left:3px;line-height:1;display:flex;position:absolute;top:0;bottom:0;left:0}.G_fTGq_earlierHistory:hover{opacity:1}.G_fTGq_earlierHistory[aria-disabled=true]{cursor:default}.G_fTGq_earlierHistory:focus-visible{box-shadow:inset 0 0 0 1px var(--dsw-alias-border-l2)}.G_fTGq_empty{color:var(--dsw-alias-label-caption);font:var(--dsw-font-xs-13);position:absolute;top:50%;left:50%;transform:translate(-50%,-50%)}.G_fTGq_track:focus-visible{outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:-1px}.G_fTGq_lanes{z-index:2;top:7px;bottom:7px;left:var(--trajectory-domain-left);width:var(--trajectory-domain-width);position:absolute}.G_fTGq_turnBoundaries{z-index:3;top:0;bottom:0;left:var(--trajectory-domain-left);width:var(--trajectory-domain-width);pointer-events:none;position:absolute}@media (prefers-reduced-motion:no-preference){.G_fTGq_lanes[data-animate-viewport=true],.G_fTGq_turnBoundaries[data-animate-viewport=true]{transition:left .18s ease-out}}.G_fTGq_turnBoundary{top:0;bottom:0;left:var(--trajectory-turn-left);background:var(--dsw-alias-border-l2);width:1px;position:absolute}.G_fTGq_span{top:calc(var(--trajectory-span-lane) * 14px);left:calc(var(--trajectory-span-left) + var(--trajectory-span-gap));width:max(2px, calc(var(--trajectory-span-width) - var(--trajectory-span-gap) - var(--trajectory-span-gap)));background:var(--dsw-alias-label-secondary);opacity:.78;border-radius:1px;min-width:2px;height:8px;position:absolute}.G_fTGq_span[data-timeline-span=user]{background:var(--dsw-alias-state-business-primary)}.G_fTGq_span[data-timeline-span=context]{background:color-mix(in srgb, var(--dsw-alias-state-success-primary) 68%, var(--dsw-alias-label-secondary))}.G_fTGq_span[data-timeline-span=message]{--trajectory-assistant-decoding-color:color-mix(in srgb, var(--dsw-alias-brand-primary-new-colorprimary-new-color) 60%, var(--dsw-alias-state-error-secondary));--trajectory-assistant-ttft-color:color-mix(in srgb, var(--trajectory-assistant-decoding-color) 54%, var(--dsw-alias-bg-layer-2));background:var(--trajectory-assistant-decoding-color);opacity:1}.G_fTGq_span[data-timeline-span=message][data-assistant-timing=true]{background:linear-gradient(to right, var(--trajectory-assistant-ttft-color) 0, var(--trajectory-assistant-ttft-color) var(--trajectory-assistant-ttft), var(--trajectory-assistant-decoding-color) var(--trajectory-assistant-ttft), var(--trajectory-assistant-decoding-color) 100%)}.G_fTGq_span[data-timeline-span=tool],.G_fTGq_span[data-timeline-span=subtool]{background:var(--dsw-alias-state-warn-label);opacity:1}.G_fTGq_span[data-error=true]{background:var(--dsw-alias-state-error-primary)}.G_fTGq_span[data-equal-duration=true]{width:8px;min-width:8px}.G_fTGq_span[data-selected=false]{opacity:.2}.G_fTGq_span[data-hovered=true]:not([data-current=true]){z-index:1;opacity:1;box-shadow:0 0 0 1px var(--dsw-alias-bg-layer-2), 0 0 0 2px color-mix(in srgb, var(--dsw-alias-state-business-primary) 80%, transparent)}.G_fTGq_span[data-current=true]{z-index:1;opacity:1;box-shadow:0 0 0 1px var(--dsw-alias-bg-layer-2), 0 0 0 2px var(--dsw-alias-state-business-primary)}.G_fTGq_span[data-search-match=false]{opacity:.14}.G_fTGq_selection{z-index:1;top:0;bottom:0;left:var(--trajectory-selection-left);width:var(--trajectory-selection-width);background:color-mix(in srgb, var(--dsw-alias-state-business-primary) 12%, transparent);min-width:1px;box-shadow:-100vw 0 0 100vw color-mix(in srgb, var(--dsw-alias-bg-layer-1) 58%, transparent), 100vw 0 0 100vw color-mix(in srgb, var(--dsw-alias-bg-layer-1) 58%, transparent);pointer-events:none;position:absolute}.G_fTGq_selectionEdges{z-index:4;top:0;bottom:0;left:var(--trajectory-selection-left);width:var(--trajectory-selection-width);pointer-events:none;min-width:1px;position:absolute}.G_fTGq_hoverLine{z-index:4;top:0;bottom:0;left:clamp(0px, calc(var(--trajectory-hover-left) - 1px), calc(100% - 2px));background:var(--dsw-alias-state-business-primary);pointer-events:none;width:2px;position:absolute}.G_fTGq_selectionEdges:before,.G_fTGq_selectionEdges:after{background:var(--dsw-alias-state-business-primary);content:\"\";width:3px;position:absolute;top:0;bottom:0}.G_fTGq_selectionEdges:before{left:0}.G_fTGq_selectionEdges:after{right:0}.G_fTGq_selectionEdges[data-dragging=true]:before,.G_fTGq_selectionEdges[data-dragging=true]:after{width:2px}.G_fTGq_selection[data-dragging=true]{background:color-mix(in srgb, var(--dsw-alias-state-business-primary) 18%, transparent)}";
		...
		var TrajectoryTimeline_module_css_default = {
			"root": "G_fTGq_root",
			"labels": "G_fTGq_labels",
			"turnBoundary": "G_fTGq_turnBoundary",
			"lanes": "G_fTGq_lanes",
			"hoverLine": "G_fTGq_hoverLine",
			"earlierHistory": "G_fTGq_earlierHistory",
			"span": "G_fTGq_span",
			"turnBoundaries": "G_fTGq_turnBoundaries",
			"empty": "G_fTGq_empty",
			"selectionEdges": "G_fTGq_selectionEdges",
			"plot": "G_fTGq_plot",
			"selection": "G_fTGq_selection",
			"track": "G_fTGq_track"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:D:\tool\deepseek-harness\packages\client\ui-trajectory\src\client\views.module.css.mjs
		const css = ".ZcOqpG_root{--dsh-trajectory-toolbar-height:32px;box-sizing:border-box;width:100%;height:100%;min-height:0;color:var(--dsw-alias-label-primary);background:var(--dsw-alias-bg-layer-1);flex-direction:column;display:flex;overflow:hidden}.ZcOqpG_ledger{z-index:0;isolation:isolate;--dsh-trajectory-bottom-clearance:calc(var(--dsh-composer-height,152px) + 16px);flex:1;min-width:0;min-height:0;display:flex;position:relative;overflow:hidden}";
