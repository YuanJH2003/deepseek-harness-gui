window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#region \0dsh-css:D:\tool\deepseek-harness\packages\client\ui-settings-plugins\src\client\fields.module.css.mjs
		const css$2 = ".Pbsv0q_field{flex-direction:column;gap:6px;padding:12px 0;display:flex}.Pbsv0q_field+.Pbsv0q_field{border-top:1px solid var(--dsw-alias-border-l2)}.Pbsv0q_head{align-items:center;gap:8px;display:flex}.Pbsv0q_label{min-width:0;color:var(--dsw-alias-label-primary);flex:1;font-size:13px;font-weight:500;line-height:1.5}.Pbsv0q_badges{align-items:center;gap:8px;display:inline-flex}.Pbsv0q_badge{white-space:nowrap;background:var(--dsw-alias-bg-module-platform);color:var(--dsw-alias-label-secondary);border-radius:999px;padding:1px 8px;font-size:11px;font-weight:500;line-height:17px}.Pbsv0q_badgeMuted{white-space:nowrap;color:var(--dsw-alias-label-tertiary);border-radius:999px;padding:1px 8px;font-size:11px;line-height:17px}.Pbsv0q_reset{font:inherit;color:var(--dsw-alias-label-secondary);cursor:pointer;background:0 0;border:none;padding:0;font-size:12px;line-height:1.5}.Pbsv0q_reset:hover:not(:disabled){color:var(--dsw-alias-label-primary)}.Pbsv0q_reset:disabled{cursor:default}.Pbsv0q_input{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-3);height:34px;font:inherit;color:var(--dsw-alias-label-primary);border-radius:8px;padding:0 12px;font-size:13px;line-height:1.5}.Pbsv0q_input:focus-visible{border-color:var(--dsw-alias-brand-primary);outline:none}.Pbsv0q_input:disabled{color:var(--dsw-alias-label-tertiary);cursor:default}.Pbsv0q_inputInvalid{border-color:var(--dsw-alias-label-error);}.Pbsv0q_invalid{color:var(--dsw-alias-label-error);margin:0;font-size:12px;line-height:1.5}.Pbsv0q_hint{color:var(--dsw-alias-label-tertiary);margin:0;font-size:12px;line-height:1.5}";
		...
		var fields_module_css_default = {
			"inputInvalid": "Pbsv0q_inputInvalid",
			"badgeMuted": "Pbsv0q_badgeMuted",
			"badges": "Pbsv0q_badges",
			"label": "Pbsv0q_label",
			"field": "Pbsv0q_field",
			"invalid": "Pbsv0q_invalid",
			"hint": "Pbsv0q_hint",
			"reset": "Pbsv0q_reset",
			"badge": "Pbsv0q_badge",
			"head": "Pbsv0q_head",
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:D:\tool\deepseek-harness\packages\client\ui-settings-plugins\src\client\PluginCard.module.css.mjs
		const css$1 = ".bnWzTa_card{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-3);border-radius:12px;list-style:none;transition:border-color .16s,background .16s}.bnWzTa_card:hover{border-color:var(--dsw-alias-label-dimmed)}.bnWzTa_cardOpen{background:var(--dsw-alias-bg-layer-2);border-color:var(--dsw-alias-label-dimmed)}.bnWzTa_header{appearance:none;width:100%;font:inherit;color:inherit;text-align:left;cursor:pointer;background:0 0;border:0;border-radius:12px;align-items:center;gap:12px;padding:14px 16px;display:flex}.bnWzTa_header:focus-visible{outline:2px solid var(--dsw-alias-brand-primary);outline-offset:-2px}.bnWzTa_headText{flex-direction:column;flex:1;gap:4px;min-width:0;display:flex}.bnWzTa_name{color:var(--dsw-alias-label-primary);font-size:15px;font-weight:600;line-height:1.4}.bnWzTa_description{color:var(--dsw-alias-label-tertiary);font-size:13px;line-height:1.5}.bnWzTa_chevron{color:var(--dsw-alias-label-tertiary);flex:none;transition:transform .16s}.bnWzTa_chevronOpen{transform:rotate(180deg)}.bnWzTa_body{border-top:1px solid var(--dsw-alias-border-l2);margin:0 16px;padding-bottom:8px}.bnWzTa_readOnly{color:var(--dsw-alias-label-tertiary);margin:12px 0 0;font-size:12px;line-height:1.5}.bnWzTa_pending{white-space:nowrap;background:var(--dsw-alias-bg-module-platform);color:var(--dsw-alias-label-secondary);border-radius:999px;flex:none;padding:1px 8px;font-size:11px;font-weight:500;line-height:17px}.bnWzTa_footer{border-top:1px solid var(--dsw-alias-border-l2);justify-content:flex-end;align-items:center;gap:8px;padding:12px 0 4px;display:flex}.bnWzTa_failed{min-width:0;color:var(--dsw-alias-label-error);flex:1;margin:0;font-size:12px;line-height:1.5}.bnWzTa_discard,.bnWzTa_save{appearance:none;font:inherit;cursor:pointer;border:1px solid #0000;border-radius:8px;padding:5px 14px;font-size:13px;line-height:1.5}.bnWzTa_discard{border-color:var(--dsw-alias-border-l2);color:var(--dsw-alias-label-secondary);background:0 0}.bnWzTa_discard:hover:not(:disabled){color:var(--dsw-alias-label-primary);border-color:var(--dsw-alias-label-dimmed)}.bnWzTa_save{background:var(--dsw-alias-label-primary);color:var(--dsw-alias-bg-layer-3)}.bnWzTa_discard:disabled,.bnWzTa_save:disabled{opacity:.4;cursor:default}.bnWzTa_discard:focus-visible,.bnWzTa_save:focus-visible{outline:2px solid var(--dsw-alias-brand-primary);outline-offset:1px}";
		...
		var PluginCard_module_css_default = {
			"cardOpen": "bnWzTa_cardOpen",
			"description": "bnWzTa_description",
			"header": "bnWzTa_header",
			"failed": "bnWzTa_failed",
			"chevronOpen": "bnWzTa_chevronOpen",
			"headText": "bnWzTa_headText",
			"body": "bnWzTa_body",
			"readOnly": "bnWzTa_readOnly",
			"discard": "bnWzTa_discard",
			"card": "bnWzTa_card",
			"save": "bnWzTa_save",
			"name": "bnWzTa_name",
			"chevron": "bnWzTa_chevron",
			"footer": "bnWzTa_footer",
			"pending": "bnWzTa_pending"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:D:\tool\deepseek-harness\packages\client\ui-settings-plugins\src\client\PluginsSettingsSection.module.css.mjs
		const css = ".CyfIYW_section{max-width:760px;color:var(--dsw-alias-label-primary);flex-direction:column;gap:12px;display:flex}.CyfIYW_heading{margin:0;font-size:18px;font-weight:600}.CyfIYW_intro{color:var(--dsw-alias-label-tertiary);margin:0;font-size:13px}.CyfIYW_tabs{border-bottom:1px solid var(--dsw-alias-border-l2);align-items:flex-end;gap:22px;margin-top:2px;display:flex}.CyfIYW_tab{color:var(--dsw-alias-label-tertiary);font:inherit;cursor:pointer;background:0 0;border:0;padding:7px 1px 9px;font-size:13px;line-height:20px;position:relative}.CyfIYW_tab:hover,.CyfIYW_tab[data-active=true]{color:var(--dsw-alias-label-primary)}.CyfIYW_tab[data-active=true]:after,.CyfIYW_tab:focus-visible:after{background:var(--dsw-alias-label-primary);content:\"\";border-radius:2px 2px 0 0;height:2px;position:absolute;bottom:-1px;left:0;right:0}.CyfIYW_tab:focus-visible{outline:2px solid var(--dsw-alias-state-business-primary);outline-offset:2px;color:var(--dsw-alias-label-primary);border-radius:2px}.CyfIYW_panel{min-width:0;padding-top:2px}.CyfIYW_cards{flex-direction:column;gap:10px;margin:0;padding:0;list-style:none;display:flex}.CyfIYW_empty{color:var(--dsw-alias-label-tertiary);margin:0;font-size:13px}";
		...
		var PluginsSettingsSection_module_css_default = {
			"cards": "CyfIYW_cards",
			"heading": "CyfIYW_heading",
			"tab": "CyfIYW_tab",
			"tabs": "CyfIYW_tabs",
			"intro": "CyfIYW_intro",
			"section": "CyfIYW_section",
			"panel": "CyfIYW_panel",
			"empty": "CyfIYW_empty"
		};
		//#endregion
