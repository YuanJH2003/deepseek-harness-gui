window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#region \0dsh-css:D:\tool\deepseek-harness\packages\client\ui-workflow-run\src\client\WorkflowRunPanel.module.css.mjs
		const css = ".mO7KtG_root{width:100%;min-width:0}.mO7KtG_runHeader{box-sizing:border-box;background:var(--dsw-alias-bg-module-platform);border-radius:8px;align-items:center;gap:6px;width:100%;min-width:0;height:32px;padding:0 8px;display:flex}.mO7KtG_runHeader:focus-visible{outline:2px solid var(--dsw-alias-state-business-primary);outline-offset:-2px}.mO7KtG_runLeading{width:16px;height:16px;color:var(--dsw-alias-label-tertiary);flex:none;justify-content:center;align-items:center;margin-right:0;display:inline-flex}.mO7KtG_runTitle{max-width:42%;color:var(--dsw-alias-label-secondary);text-overflow:ellipsis;white-space:nowrap;flex:none;font-size:14px;font-weight:510;line-height:24px;overflow:hidden}.mO7KtG_runSummary{min-width:0;color:var(--dsw-alias-label-tertiary);text-overflow:ellipsis;white-space:nowrap;flex:1;font-size:12px;line-height:18px;overflow:hidden}.mO7KtG_statusTail{height:20px;color:var(--dsw-alias-label-secondary);white-space:nowrap;flex:none;align-items:center;gap:4px;font-size:11px;font-weight:510;line-height:16px;display:inline-flex;overflow:hidden}.mO7KtG_phaseHeader{box-sizing:border-box;align-items:center;gap:6px;width:100%;min-width:0;height:32px;display:flex}.mO7KtG_phaseHeader:focus-visible{outline:2px solid var(--dsw-alias-state-business-primary);outline-offset:-2px;border-radius:4px}.mO7KtG_phaseLeading{width:16px;height:16px;color:var(--dsw-alias-label-tertiary);flex:none;justify-content:center;align-items:center;margin-right:0;display:inline-flex}.mO7KtG_phaseTitle{min-width:0;max-width:42%;color:var(--dsw-alias-label-secondary);text-overflow:ellipsis;white-space:nowrap;flex:0 auto;font-size:14px;line-height:24px;overflow:hidden}.mO7KtG_phaseCount{min-width:0;color:var(--dsw-alias-label-tertiary);text-overflow:ellipsis;white-space:nowrap;flex:1;font-size:13px;line-height:20px;overflow:hidden}.mO7KtG_phaseStatus{width:132px;color:var(--dsw-alias-label-secondary);text-align:right;text-overflow:ellipsis;white-space:nowrap;flex:none;font-size:13px;line-height:20px;overflow:hidden}.mO7KtG_separator{background:var(--dsw-alias-label-tertiary);border-radius:50%;flex:none;width:2px;height:2px}.mO7KtG_phaseList{flex-direction:column;gap:4px;min-width:0;padding:4px 0 0 16px;display:flex}.mO7KtG_phase{min-width:0}.mO7KtG_members{flex-direction:column;gap:2px;min-width:0;padding:0 0 0 16px;display:flex}.mO7KtG_memberRow,.mO7KtG_memberButton{width:100%;min-width:0;min-height:24px;color:var(--dsw-alias-label-secondary);font:inherit;text-align:left;background:0 0;border:0;border-radius:4px;align-items:center;gap:12px;padding:0;display:flex}.mO7KtG_memberButton{cursor:pointer}.mO7KtG_memberButton .mO7KtG_memberLabel{color:var(--dsw-alias-state-business-primary);text-underline-position:from-font;text-decoration:underline}.mO7KtG_dotSlot{flex:none;justify-content:center;align-items:center;width:16px;height:24px;display:inline-flex;overflow:hidden}.mO7KtG_memberButton:focus-visible{outline:none}.mO7KtG_memberButton:focus-visible .mO7KtG_memberLabelWrap{outline:2px solid var(--dsw-alias-state-business-primary);outline-offset:-1px}.mO7KtG_memberLabelWrap{border-radius:4px;flex:1;align-items:center;min-width:0;height:24px;padding:0 2px;display:flex;overflow:hidden}.mO7KtG_memberLabel{min-width:0;color:var(--dsw-alias-label-secondary);text-overflow:ellipsis;white-space:nowrap;flex:1;font-size:14px;line-height:24px;overflow:hidden}.mO7KtG_memberStatus{width:64px;color:var(--dsw-alias-label-secondary);text-align:right;text-overflow:ellipsis;white-space:nowrap;flex:none;font-size:13px;line-height:20px;overflow:hidden}.mO7KtG_empty{color:var(--dsw-alias-label-tertiary);padding:0;font-size:13px;line-height:20px}@media (width<=560px){.mO7KtG_phaseList,.mO7KtG_members{padding-left:12px}}";
		...
		var WorkflowRunPanel_module_css_default = {
			"members": "mO7KtG_members",
			"memberRow": "mO7KtG_memberRow",
			"memberButton": "mO7KtG_memberButton",
			"phaseStatus": "mO7KtG_phaseStatus",
			"root": "mO7KtG_root",
			"empty": "mO7KtG_empty",
			"phaseHeader": "mO7KtG_phaseHeader",
			"phase": "mO7KtG_phase",
			"runHeader": "mO7KtG_runHeader",
			"phaseTitle": "mO7KtG_phaseTitle",
			"memberLabelWrap": "mO7KtG_memberLabelWrap",
			"memberLabel": "mO7KtG_memberLabel",
			"dotSlot": "mO7KtG_dotSlot",
			"memberStatus": "mO7KtG_memberStatus",
			"statusTail": "mO7KtG_statusTail",
			"runTitle": "mO7KtG_runTitle",
			"phaseCount": "mO7KtG_phaseCount",
			"phaseList": "mO7KtG_phaseList",
			"separator": "mO7KtG_separator",
			"runSummary": "mO7KtG_runSummary",
			"phaseLeading": "mO7KtG_phaseLeading",
			"runLeading": "mO7KtG_runLeading"
		};
		//#endregion
