window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:D:\tool\deepseek-harness\packages\client\ui-user-questions\src\client\PlanReviewPanel.module.css.mjs
		const css$1 = "._2fgvbW_frame{padding:6px calc(var(--dsh-composer-side-clearance) + 16px) 10px;justify-content:center;display:flex}._2fgvbW_card{width:100%;max-width:var(--dsh-chat-content-width);border:1px solid var(--dsw-alias-state-warn-secondary);background:var(--dsw-specific-input-major);max-height:min(60vh,520px);box-shadow:var(--dsw-shadow-lv2);color:var(--dsw-alias-label-primary);--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);border-radius:20px;flex-direction:column;display:flex;overflow:hidden}._2fgvbW_card,._2fgvbW_card *{box-sizing:border-box}._2fgvbW_strip{background:var(--dsw-alias-state-warn-tertiary);color:var(--dsw-alias-state-warn-primary);flex-shrink:0;align-items:center;gap:8px;padding:10px 16px;font-size:13px;line-height:18px;display:flex}._2fgvbW_dot{background:var(--dsw-alias-state-warn-primary);border-radius:50%;width:8px;height:8px}._2fgvbW_body{overscroll-behavior:contain;flex:auto;min-height:0;padding:12px 16px 4px;font-size:14px;line-height:22px;overflow-y:auto}._2fgvbW_footer{flex-shrink:0;justify-content:space-between;align-items:center;gap:12px;padding:8px 16px 12px;display:flex}._2fgvbW_feedback{min-height:16px;color:var(--dsw-alias-state-error-primary);font-size:11px;line-height:16px}._2fgvbW_actions{flex-shrink:0;align-items:center;gap:8px;display:flex}._2fgvbW_discuss{color:var(--dsw-alias-label-secondary);gap:6px}._2fgvbW_discuss:hover:not(:disabled){color:var(--dsw-alias-label-primary)}@media (width<=720px){._2fgvbW_card{border-radius:16px}._2fgvbW_body{padding:10px 12px 4px}._2fgvbW_footer{align-items:flex-end;padding:8px 12px 10px}}";
		...
		var PlanReviewPanel_module_css_default = {
			"footer": "_2fgvbW_footer",
			"discuss": "_2fgvbW_discuss",
			"card": "_2fgvbW_card",
			"dot": "_2fgvbW_dot",
			"strip": "_2fgvbW_strip",
			"frame": "_2fgvbW_frame",
			"actions": "_2fgvbW_actions",
			"feedback": "_2fgvbW_feedback",
			"body": "_2fgvbW_body"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:D:\tool\deepseek-harness\packages\client\ui-user-questions\src\client\QuestionComposer.module.css.mjs
		const css = "._2spiIq_frame{padding:6px calc(var(--dsh-composer-side-clearance) + 16px) 10px;justify-content:center;display:flex}._2spiIq_card{width:100%;max-width:var(--dsh-chat-content-width);border:1px solid var(--dsw-alias-border-l2-darkmode-thin);background:var(--dsw-specific-input-major);max-height:min(60vh,520px);box-shadow:var(--dsw-shadow-lv2);color:var(--dsw-alias-label-primary);--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);border-radius:20px;flex-direction:column;padding:0 0 10px;display:flex;overflow:hidden}._2spiIq_card,._2spiIq_card *{box-sizing:border-box}._2spiIq_header{flex-shrink:0;justify-content:space-between;align-items:flex-start;gap:16px;padding:20px 16px 0 24px;display:flex}._2spiIq_headingBlock{min-width:0}._2spiIq_eyebrow{color:var(--dsw-alias-label-tertiary);margin-bottom:5px;font-size:11px;line-height:16px}._2spiIq_title{margin:0;font-size:16px;font-weight:500;line-height:22px}._2spiIq_detail{margin:0 2px 8px}._2spiIq_footerActions{flex-shrink:0;align-items:center;gap:12px;display:flex}._2spiIq_pager{flex-shrink:0;align-items:center;gap:6px;display:flex}._2spiIq_progress{color:var(--dsw-alias-label-secondary);white-space:nowrap;word-spacing:-2px;padding:0 4px;font-size:14px;font-weight:500;line-height:24px}._2spiIq_iconButton{width:24px;height:24px;color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:none;border-radius:999px;place-items:center;padding:0;display:grid}._2spiIq_iconButton:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-primary)}._2spiIq_iconButton:disabled{color:var(--dsw-alias-label-dimmed);cursor:default}._2spiIq_body{overscroll-behavior:contain;flex-direction:column;flex:auto;min-height:0;display:flex;overflow-y:auto}._2spiIq_options{flex-direction:column;gap:1px;margin:8px 0 0;padding:4px 12px;display:flex}._2spiIq_option{width:100%;min-height:40px;color:inherit;text-align:left;cursor:pointer;background:0 0;border:1px solid #0000;border-radius:12px;flex-shrink:0;align-items:flex-start;gap:8px;padding:8px 12px 8px 8px;transition:background-color .12s,border-color .12s;display:flex}._2spiIq_option:hover:not(:disabled),._2spiIq_optionSelected{background:var(--dsw-alias-interactive-bg-hover)}._2spiIq_optionSelected{border-color:var(--dsw-alias-border-l2)}._2spiIq_option:disabled{cursor:default}._2spiIq_number{background:var(--dsw-alias-bg-overlay);width:20px;height:20px;color:var(--dsw-alias-label-secondary);border-radius:6px;flex:0 0 20px;place-items:center;margin-top:2px;font-size:12px;font-weight:500;line-height:18px;display:grid}._2spiIq_checkbox{flex:0 0 20px;place-items:center;width:20px;height:20px;margin-top:2px;display:grid}._2spiIq_checkbox:before{content:\"\";border:1px solid var(--dsw-alias-border-l4);border-radius:4px;grid-area:1/1;width:14px;height:14px;transition:background-color .12s,border-color .12s}._2spiIq_checkbox>svg{grid-area:1/1}._2spiIq_checkboxChecked{color:var(--dsw-alias-label-primary-foreground)}._2spiIq_checkboxChecked:before{border-color:var(--dsw-alias-label-primary);background:var(--dsw-alias-label-primary)}._2spiIq_optionCopy{flex:1;min-width:0}._2spiIq_optionLine{flex-wrap:wrap;align-items:baseline;gap:2px 6px;display:flex}._2spiIq_optionLabel{font-size:14px;font-weight:500;line-height:24px}._2spiIq_badge{background:var(--dsw-specific-sidebar-nav-item-active-accent);color:var(--dsw-alias-button-info-fill);border-radius:6px;padding:0 4px;font-size:11px;font-weight:600;line-height:18px}._2spiIq_description{color:var(--dsw-alias-label-tertiary);font-size:14px;font-weight:400;line-height:24px}._2spiIq_customRow{border:1px solid #0000;border-radius:12px;flex-shrink:0;align-items:flex-start;gap:8px;width:100%;min-height:40px;padding:8px 12px 8px 8px;transition:background-color .12s,border-color .12s;display:flex}._2spiIq_customRow:hover,._2spiIq_customRow:focus-within,._2spiIq_customRowActive{background:var(--dsw-alias-interactive-bg-hover)}._2spiIq_customRow:focus-within,._2spiIq_customRowActive{border-color:var(--dsw-alias-border-l2)}._2spiIq_customInput{min-width:0;color:var(--dsw-alias-label-primary);caret-color:var(--dsw-alias-state-business-primary);font:inherit;background:0 0;border:none;outline:none;flex:1;padding:0;font-size:14px;line-height:24px}._2spiIq_customInput::placeholder{color:var(--dsw-alias-label-caption)}._2spiIq_customTextarea{resize:none;border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-module-platform);min-height:64px;max-height:140px;color:var(--dsw-alias-label-primary);caret-color:var(--dsw-alias-state-business-primary);font:inherit;border-radius:10px;outline:none;flex-shrink:0;margin:0 12px;padding:8px 12px;font-size:14px;line-height:24px;display:block}._2spiIq_customTextarea:focus{border-color:var(--dsw-alias-state-business-primary)}._2spiIq_customTextarea::placeholder{color:var(--dsw-alias-label-caption)}._2spiIq_footer{flex-shrink:0;justify-content:space-between;align-items:center;gap:12px;margin-top:12px;padding:0 10px 0 18px;display:flex}._2spiIq_feedback{min-height:16px;color:var(--dsw-alias-state-error-primary);text-align:right;flex:1;font-size:11px;line-height:16px}@media (width<=720px){._2spiIq_card{border-radius:16px}._2spiIq_header{padding:10px 12px 0 18px}._2spiIq_options{padding:4px 8px}._2spiIq_title{font-size:15px;line-height:21px}._2spiIq_option,._2spiIq_customRow{padding:8px 6px}._2spiIq_footer{align-items:flex-end;padding:0 10px}._2spiIq_footerActions{flex-shrink:0}}@media (prefers-reduced-motion:reduce){._2spiIq_option,._2spiIq_customRow{transition:none}}";
		...
		var QuestionComposer_module_css_default = {
			"header": "_2spiIq_header",
			"option": "_2spiIq_option",
			"description": "_2spiIq_description",
			"detail": "_2spiIq_detail",
			"footerActions": "_2spiIq_footerActions",
			"eyebrow": "_2spiIq_eyebrow",
			"customRow": "_2spiIq_customRow",
			"pager": "_2spiIq_pager",
			"footer": "_2spiIq_footer",
			"progress": "_2spiIq_progress",
			"iconButton": "_2spiIq_iconButton",
			"title": "_2spiIq_title",
			"customRowActive": "_2spiIq_customRowActive",
			"customTextarea": "_2spiIq_customTextarea",
			"checkbox": "_2spiIq_checkbox",
			"headingBlock": "_2spiIq_headingBlock",
			"badge": "_2spiIq_badge",
			"body": "_2spiIq_body",
			"optionLine": "_2spiIq_optionLine",
			"optionCopy": "_2spiIq_optionCopy",
			"card": "_2spiIq_card",
			"optionSelected": "_2spiIq_optionSelected",
			"checkboxChecked": "_2spiIq_checkboxChecked",
			"feedback": "_2spiIq_feedback",
			"number": "_2spiIq_number",
			"optionLabel": "_2spiIq_optionLabel",
			"options": "_2spiIq_options",
			"customInput": "_2spiIq_customInput",
			"frame": "_2spiIq_frame"
		};
		//#endregion
