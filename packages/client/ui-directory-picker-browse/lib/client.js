window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#endregion
		//#region \0dsh-css:D:\tool\deepseek-harness\packages\client\ui-directory-picker-browse\src\client\DirectoryBrowser.module.css.mjs
		const css = ".MpLO7q_dialog.MpLO7q_dialog{--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);gap:0;width:min(680px,100%);height:min(500px,100dvh - 32px);padding:0}.MpLO7q_editorScope{display:contents}.MpLO7q_header{border-bottom:1px solid var(--dsw-alias-border-l3);flex-direction:column;flex:none;gap:8px;padding:16px 14px 8px 24px;display:flex}.MpLO7q_title{min-height:28px;color:var(--dsw-alias-label-primary);align-items:flex-end;margin:0;font-size:16px;font-weight:510;line-height:24px;display:flex}.MpLO7q_crumbBar{box-sizing:border-box;border:1px solid #0000;border-radius:8px;align-items:center;gap:4px;min-height:24px;margin-left:-9px;padding:0 8px;display:flex}.MpLO7q_crumbBar:has(.MpLO7q_crumbEditZone:enabled:hover),.MpLO7q_crumbBar:has(.MpLO7q_crumbEditZone:focus-visible),.MpLO7q_crumbBar:has(.MpLO7q_pathInput){border-color:var(--dsw-alias-border-l2)}.MpLO7q_millerRow{scrollbar-width:none;flex:1 1 0;align-items:stretch;gap:12px;min-height:0;display:flex;overflow-x:auto}.MpLO7q_crumbTrail{scrollbar-width:none;flex:0 auto;align-items:center;gap:4px;min-width:0;display:flex;overflow-x:auto}.MpLO7q_crumbSeat{flex:none;align-items:center;gap:4px;min-width:0;display:inline-flex}.MpLO7q_crumb{text-overflow:ellipsis;white-space:nowrap;max-width:160px;color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:none;padding:0;font-size:13px;font-weight:500;line-height:20px;overflow:hidden}.MpLO7q_crumb:hover{color:var(--dsw-alias-label-primary)}.MpLO7q_crumbChevron{color:var(--dsw-alias-label-tertiary);flex:none}.MpLO7q_crumbEditZone{cursor:text;background:0 0;border:none;outline:none;flex:1 0 34px;justify-content:flex-end;align-items:center;min-width:34px;height:22px;padding:0;display:flex}.MpLO7q_crumbEditGlyph{color:var(--dsw-alias-label-tertiary);flex:none}.MpLO7q_crumbEditZone:enabled:hover .MpLO7q_crumbEditGlyph,.MpLO7q_crumbEditZone:focus-visible .MpLO7q_crumbEditGlyph{color:var(--dsw-alias-label-primary)}.MpLO7q_crumbEditZone:disabled{cursor:default}.MpLO7q_crumbEditZone:disabled .MpLO7q_crumbEditGlyph{color:var(--dsw-alias-label-caption)}.MpLO7q_pathInput{box-sizing:border-box;min-width:0;height:22px;color:var(--dsw-alias-label-primary);background:0 0;border:none;outline:none;flex:1 1 0;padding:0;font-size:13px;line-height:20px}.MpLO7q_content{flex-direction:column;flex:1 1 0;min-height:0;padding:16px 16px 16px 24px;display:flex;position:relative}.MpLO7q_column{flex-direction:column;flex:1 1 0;gap:2px;min-width:256px;padding-right:8px;display:flex;overflow-y:auto}.MpLO7q_divider{background:var(--dsw-alias-border-l3);flex:none;width:1px}.MpLO7q_rowSeat{flex:none;display:flex}.MpLO7q_row{text-align:left;cursor:pointer;background:0 0;border:none;border-radius:6px;flex:none;align-items:center;gap:4px;width:100%;height:28px;padding:4px;display:flex}.MpLO7q_row:hover{background:var(--dsw-alias-interactive-bg-hover)}.MpLO7q_rowSelected,.MpLO7q_rowSelected:hover{background:var(--dsw-alias-interactive-bg-active,var(--dsw-alias-interactive-bg-hover))}.MpLO7q_rowIcon{color:var(--dsw-alias-label-secondary);flex:none}.MpLO7q_rowIconSelected{color:var(--dsw-alias-button-info-fill);flex:none}.MpLO7q_rowName{text-overflow:ellipsis;white-space:nowrap;min-width:0;color:var(--dsw-alias-label-primary);flex:1 1 0;font-size:13px;font-weight:500;line-height:20px;overflow:hidden}.MpLO7q_rowChevron{color:var(--dsw-alias-label-tertiary);flex:none}.MpLO7q_status,.MpLO7q_error{padding:4px 120px 4px 4px;font-size:12px;line-height:18px}.MpLO7q_status{color:var(--dsw-alias-label-secondary)}.MpLO7q_error{color:var(--dsw-alias-state-error-primary)}.MpLO7q_loadingFloat{background:var(--dsw-alias-bg-layer-2);padding:2px 8px;position:absolute;bottom:8px;right:16px}.MpLO7q_footerBar{border-top:1px solid var(--dsw-alias-border-l3);flex-wrap:wrap;flex:none;align-items:center;gap:8px;padding:16px 24px;display:flex}.MpLO7q_showHiddenToggle{color:var(--dsw-alias-label-secondary);cursor:pointer;white-space:nowrap;background:0 0;border:none;align-items:center;gap:4px;padding:0;font-size:13px;font-weight:500;line-height:20px;display:inline-flex}.MpLO7q_showHiddenToggle:hover{color:var(--dsw-alias-label-primary)}.MpLO7q_showHiddenToggle:disabled{color:var(--dsw-alias-label-caption);cursor:default}.MpLO7q_showHiddenToggleActive{color:var(--dsw-alias-label-primary)}.MpLO7q_footerGap{flex:1 1 0}.MpLO7q_footerAction{min-width:72px}.MpLO7q_createDialog.MpLO7q_createDialog{gap:0;width:min(380px,100%);padding:0}.MpLO7q_createBody{flex-direction:column;gap:12px;padding:22px 24px 20px;display:flex}.MpLO7q_createTitle{color:var(--dsw-alias-label-primary);margin:0;font-size:16px;font-weight:510;line-height:24px}.MpLO7q_createIn{color:var(--dsw-alias-label-primary);margin:0;font-size:14px;line-height:22px}.MpLO7q_createInput{box-sizing:border-box;border:1px solid var(--dsw-alias-border-l2);width:100%;height:44px;color:var(--dsw-alias-label-primary);background:0 0;border-radius:22px;outline:none;padding:7px 14px;font-size:14px;line-height:22px}.MpLO7q_createInput::placeholder{color:var(--dsw-alias-label-caption)}.MpLO7q_createActions{justify-content:flex-end;align-items:center;gap:8px;margin-top:8px;display:flex}";
		...
		var DirectoryBrowser_module_css_default = {
			"column": "MpLO7q_column",
			"rowChevron": "MpLO7q_rowChevron",
			"createDialog": "MpLO7q_createDialog",
			"crumbTrail": "MpLO7q_crumbTrail",
			"rowSelected": "MpLO7q_rowSelected",
			"createActions": "MpLO7q_createActions",
			"crumb": "MpLO7q_crumb",
			"showHiddenToggleActive": "MpLO7q_showHiddenToggleActive",
			"header": "MpLO7q_header",
			"divider": "MpLO7q_divider",
			"crumbSeat": "MpLO7q_crumbSeat",
			"status": "MpLO7q_status",
			"footerGap": "MpLO7q_footerGap",
			"crumbEditZone": "MpLO7q_crumbEditZone",
			"row": "MpLO7q_row",
			"showHiddenToggle": "MpLO7q_showHiddenToggle",
			"createInput": "MpLO7q_createInput",
			"footerAction": "MpLO7q_footerAction",
			"rowName": "MpLO7q_rowName",
			"rowSeat": "MpLO7q_rowSeat",
			"title": "MpLO7q_title",
			"crumbEditGlyph": "MpLO7q_crumbEditGlyph",
			"loadingFloat": "MpLO7q_loadingFloat",
			"createBody": "MpLO7q_createBody",
			"dialog": "MpLO7q_dialog",
			"editorScope": "MpLO7q_editorScope",
			"rowIconSelected": "MpLO7q_rowIconSelected",
			"rowIcon": "MpLO7q_rowIcon",
			"createTitle": "MpLO7q_createTitle",
			"createIn": "MpLO7q_createIn",
			"content": "MpLO7q_content",
			"error": "MpLO7q_error",
			"crumbBar": "MpLO7q_crumbBar",
			"millerRow": "MpLO7q_millerRow",
			"crumbChevron": "MpLO7q_crumbChevron",
			"pathInput": "MpLO7q_pathInput",
			"footerBar": "MpLO7q_footerBar"
		};
		//#endregion
