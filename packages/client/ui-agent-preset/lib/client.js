window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:D:\tool\deepseek-harness\packages\client\ui-agent-preset\src\client\AgentPresetRow.module.css.mjs
		const css$2 = ".Bj7QPG_row{border-bottom:1px solid var(--dsw-alias-border-l2);align-items:center;gap:8px;padding:16px 0;display:flex}.Bj7QPG_rowText{flex-direction:column;flex:1;gap:4px;min-width:0;padding-right:48px;display:flex}.Bj7QPG_title{color:var(--dsw-alias-label-primary);font-size:14px;font-weight:400;line-height:22px}.Bj7QPG_desc{color:var(--dsw-alias-label-tertiary);font-size:12px;font-weight:400;line-height:18px}.Bj7QPG_selector{background:var(--dsw-alias-bg-module-platform);height:36px;font:inherit;color:var(--dsw-alias-label-primary);cursor:pointer;border:none;border-radius:18px;align-items:center;gap:12px;padding:0 14px;font-size:14px;line-height:22px;display:inline-flex}.Bj7QPG_selector:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover)}.Bj7QPG_selector:disabled{cursor:default}.Bj7QPG_chevron{flex:none}";
		...
		var AgentPresetRow_module_css_default = {
			"selector": "Bj7QPG_selector",
			"chevron": "Bj7QPG_chevron",
			"desc": "Bj7QPG_desc",
			"row": "Bj7QPG_row",
			"title": "Bj7QPG_title",
			"rowText": "Bj7QPG_rowText"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:D:\tool\deepseek-harness\packages\client\ui-agent-preset\src\client\AgentPresetSeat.module.css.mjs
		const css$1 = ".TksLUW_seat{max-width:min(100%,240px);min-height:28px;color:var(--dsw-alias-label-primary);white-space:nowrap;text-overflow:ellipsis;cursor:pointer;background:0 0;border:none;border-radius:16px;align-items:center;gap:4px;padding:0 8px;font-size:13px;font-weight:500;line-height:20px;display:inline-flex;overflow:hidden}.TksLUW_seat:not(:disabled):hover,.TksLUW_seat[aria-expanded=true]{background:var(--dsw-alias-interactive-bg-hover)}.TksLUW_seat:disabled{cursor:default;color:var(--dsw-alias-label-quaternary)}.TksLUW_seatIcon{color:var(--dsw-alias-label-primary);flex:none}.TksLUW_introIcon{animation:.15s cubic-bezier(.16,1,.3,1) both TksLUW_seat-icon-in}@keyframes TksLUW_seat-icon-in{0%{opacity:0;transform:scale(.5)}to{opacity:1;transform:scale(1)}}.TksLUW_introText{white-space:pre;display:inline-block}.TksLUW_introChar{white-space:pre;opacity:0;animation:.4s ease-out forwards TksLUW_seat-char-in;display:inline-block}@keyframes TksLUW_seat-char-in{0%{opacity:0;transform:translateY(4px)}to{opacity:1;transform:none}}@media (prefers-reduced-motion:reduce){.TksLUW_introIcon,.TksLUW_introChar{opacity:1;animation:none}}.TksLUW_chevron{color:var(--dsw-alias-label-caption);flex:none}.TksLUW_item{flex-direction:column;gap:2px;max-width:280px;display:flex}.TksLUW_itemName{color:var(--dsw-alias-label-primary);font-size:13px;line-height:20px}.TksLUW_itemDesc{color:var(--dsw-alias-label-caption);white-space:normal;font-size:12px;line-height:16px}";
		...
		var AgentPresetSeat_module_css_default = {
			"seat": "TksLUW_seat",
			"item": "TksLUW_item",
			"itemDesc": "TksLUW_itemDesc",
			"seat-icon-in": "TksLUW_seat-icon-in",
			"introIcon": "TksLUW_introIcon",
			"introChar": "TksLUW_introChar",
			"seat-char-in": "TksLUW_seat-char-in",
			"chevron": "TksLUW_chevron",
			"itemName": "TksLUW_itemName",
			"introText": "TksLUW_introText",
			"seatIcon": "TksLUW_seatIcon"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:D:\tool\deepseek-harness\packages\client\ui-agent-preset\src\client\AgentPresetSection.module.css.mjs
		const css = ".U6Kx1G_section{max-width:720px;color:var(--dsw-alias-label-primary);flex-direction:column;gap:12px;display:flex}.U6Kx1G_title{margin:0;font-size:18px;font-weight:600}.U6Kx1G_intro{color:var(--dsw-alias-label-tertiary);margin:0;font-size:13px}.U6Kx1G_group{flex-direction:column;gap:10px;display:flex}.U6Kx1G_group+.U6Kx1G_group{margin-top:20px}.U6Kx1G_groupHead{letter-spacing:.06em;text-transform:uppercase;color:var(--dsw-alias-label-tertiary);margin:0;font-size:12px;font-weight:600}.U6Kx1G_cards{grid-template-columns:repeat(auto-fill,minmax(268px,1fr));grid-auto-rows:1fr;gap:12px;margin:0;padding:0;list-style:none;display:grid}.U6Kx1G_card{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-3);border-radius:12px;flex-direction:column;transition:border-color .16s,background .16s;display:flex}.U6Kx1G_card:hover:not(.U6Kx1G_cardActive){border-color:var(--dsw-alias-label-dimmed)}.U6Kx1G_cardActive{background:var(--dsw-alias-bg-layer-2);border-color:var(--dsw-alias-label-primary)}.U6Kx1G_cardBroken,.U6Kx1G_cardBroken:hover{border-color:var(--dsw-alias-state-error-primary)}.U6Kx1G_brokenBadge{white-space:nowrap;background:var(--dsw-alias-state-error-primary);color:var(--dsw-alias-bg-layer-3);border-radius:999px;padding:1px 8px;font-size:11px;font-weight:500;line-height:17px}.U6Kx1G_cardBrokenReason{color:var(--dsw-alias-state-error-primary);overflow-wrap:anywhere;font-size:12px;line-height:1.5}.U6Kx1G_cardMain{appearance:none;font:inherit;color:inherit;text-align:left;cursor:pointer;background:0 0;border:0;border-radius:12px 12px 0 0;flex-direction:column;flex:1;gap:8px;padding:14px 16px 12px;display:flex}.U6Kx1G_cardMain:disabled{cursor:default}.U6Kx1G_cardMain:focus-visible{outline:2px solid var(--dsw-alias-brand-primary);outline-offset:-2px}.U6Kx1G_cardHead{align-items:center;gap:8px;display:flex}.U6Kx1G_cardName{font-size:15px;font-weight:600;line-height:1.4}.U6Kx1G_badge,.U6Kx1G_inUse{white-space:nowrap;border-radius:999px;padding:1px 8px;font-size:11px;font-weight:500;line-height:17px}.U6Kx1G_badge{border:1px solid var(--dsw-alias-border-l2);color:var(--dsw-alias-label-tertiary)}.U6Kx1G_inUse{background:var(--dsw-alias-label-primary);color:var(--dsw-alias-bg-layer-3);margin-left:auto}.U6Kx1G_cardDesc{color:var(--dsw-alias-label-secondary);-webkit-line-clamp:4;overflow-wrap:anywhere;-webkit-box-orient:vertical;min-height:42px;font-size:13px;line-height:1.55;display:-webkit-box;overflow:hidden}.U6Kx1G_cardId{font-family:var(--dsw-font-mono,ui-monospace, SFMono-Regular, Menlo, monospace);color:var(--dsw-alias-label-dimmed);margin-top:auto;font-size:11px}.U6Kx1G_cardFoot{border-top:1px solid var(--dsw-alias-border-l2);justify-content:flex-end;gap:2px;padding:6px 10px;display:flex}.U6Kx1G_iconButton{appearance:none;color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:0;border-radius:7px;align-items:center;padding:6px;display:inline-flex;position:relative}.U6Kx1G_iconButton:disabled{opacity:.4;cursor:default}.U6Kx1G_iconButton:hover:not(:disabled){background:var(--dsw-alias-bg-layer-1);color:var(--dsw-alias-label-primary)}.U6Kx1G_iconButton:focus-visible{outline:2px solid var(--dsw-alias-brand-primary);outline-offset:-1px}.U6Kx1G_iconButton:after{content:attr(data-tip);background:var(--dsw-alias-label-primary);color:var(--dsw-alias-bg-layer-3);white-space:nowrap;opacity:0;pointer-events:none;border-radius:6px;padding:3px 8px;font-size:11px;line-height:17px;transition:opacity .12s;position:absolute;bottom:calc(100% + 6px);left:50%;transform:translate(-50%)}.U6Kx1G_iconButton:hover:after,.U6Kx1G_iconButton:focus-visible:after{opacity:1}.U6Kx1G_iconDanger:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover-danger);color:var(--dsw-alias-state-error-primary)}.U6Kx1G_revealedPath{color:var(--dsw-alias-label-tertiary);align-items:baseline;gap:6px;margin:0;padding:6px 16px 10px;font-size:11px;display:flex}.U6Kx1G_revealedPath code{font-family:var(--dsw-font-mono,ui-monospace, SFMono-Regular, Menlo, monospace);color:var(--dsw-alias-label-secondary);user-select:all;overflow-wrap:anywhere}.U6Kx1G_revealedPathLabel{white-space:nowrap}.U6Kx1G_secondaryButton{color:var(--dsw-alias-label-secondary);font:inherit;cursor:pointer;background:0 0;border:none;border-radius:7px;padding:5px 8px;font-size:12.5px}.U6Kx1G_secondaryButton:hover:not(:disabled){background:var(--dsw-alias-bg-layer-1)}.U6Kx1G_secondaryButton:disabled{opacity:.5;cursor:default}.U6Kx1G_field{flex-direction:column;gap:6px;display:flex}.U6Kx1G_fieldLabel{color:var(--dsw-alias-label-secondary);font-size:12px;font-weight:500}.U6Kx1G_input{box-sizing:border-box;border:1px solid var(--dsw-alias-border-l2);font:inherit;background:var(--dsw-alias-bg-layer-1);color:var(--dsw-alias-label-primary);border-radius:10px;padding:9px 12px;font-size:13px}.U6Kx1G_input:focus{border-color:var(--dsw-alias-brand-primary);outline:none}.U6Kx1G_input::placeholder{color:var(--dsw-alias-label-dimmed)}.U6Kx1G_dialog{width:min(560px,100%)}.U6Kx1G_dialogFields{flex-direction:column;gap:12px;display:flex}.U6Kx1G_viewerCode{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-2);max-height:min(52vh,480px);color:var(--dsw-alias-label-secondary);font-family:var(--dsw-font-mono,ui-monospace, SFMono-Regular, Menlo, monospace);white-space:pre;tab-size:2;--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);border-radius:10px;margin:0;padding:12px;font-size:12.5px;line-height:1.5;overflow:auto}.U6Kx1G_error{color:var(--dsw-alias-state-error-primary);margin:0;font-size:12px}.U6Kx1G_deleteDialog{width:min(480px,100%)}.U6Kx1G_deleteConfirm:not(:disabled){border-color:var(--dsw-alias-state-error-primary);color:var(--dsw-alias-state-error-primary)}.U6Kx1G_deleteConfirm:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover-danger)}.U6Kx1G_creatorButton{box-sizing:border-box;border:1px dashed var(--dsw-alias-border-l3);height:44px;font:inherit;color:var(--dsw-alias-label-primary);cursor:pointer;background:0 0;border-radius:12px;justify-content:center;align-self:stretch;align-items:center;gap:6px;font-size:14px;line-height:22px;display:flex}.U6Kx1G_creatorButton:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover)}.U6Kx1G_creatorButton:disabled{opacity:.4;cursor:default}";
		...
		var AgentPresetSection_module_css_default = {
			"revealedPath": "U6Kx1G_revealedPath",
			"card": "U6Kx1G_card",
			"deleteDialog": "U6Kx1G_deleteDialog",
			"cardName": "U6Kx1G_cardName",
			"group": "U6Kx1G_group",
			"cardActive": "U6Kx1G_cardActive",
			"cardId": "U6Kx1G_cardId",
			"title": "U6Kx1G_title",
			"cardFoot": "U6Kx1G_cardFoot",
			"input": "U6Kx1G_input",
			"cardMain": "U6Kx1G_cardMain",
			"dialog": "U6Kx1G_dialog",
			"deleteConfirm": "U6Kx1G_deleteConfirm",
			"cardBroken": "U6Kx1G_cardBroken",
			"brokenBadge": "U6Kx1G_brokenBadge",
			"badge": "U6Kx1G_badge",
			"iconDanger": "U6Kx1G_iconDanger",
			"section": "U6Kx1G_section",
			"creatorButton": "U6Kx1G_creatorButton",
			"fieldLabel": "U6Kx1G_fieldLabel",
			"intro": "U6Kx1G_intro",
			"revealedPathLabel": "U6Kx1G_revealedPathLabel",
			"secondaryButton": "U6Kx1G_secondaryButton",
			"error": "U6Kx1G_error",
			"iconButton": "U6Kx1G_iconButton",
			"cardDesc": "U6Kx1G_cardDesc",
			"groupHead": "U6Kx1G_groupHead",
			"cards": "U6Kx1G_cards",
			"field": "U6Kx1G_field",
			"dialogFields": "U6Kx1G_dialogFields",
			"cardBrokenReason": "U6Kx1G_cardBrokenReason",
			"inUse": "U6Kx1G_inUse",
			"cardHead": "U6Kx1G_cardHead",
			"viewerCode": "U6Kx1G_viewerCode"
		};
		//#endregion
