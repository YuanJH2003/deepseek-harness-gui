window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:D:\tool\deepseek-harness\packages\client\ui-tool\src\client\tool\components\ToolRow.module.css.mjs
		const css$3 = ".aCs5ca_root{flex-direction:column;display:flex}.aCs5ca_row{position:relative;overflow:hidden}.aCs5ca_root[data-state=running] .aCs5ca_row:after{content:\"\";background:linear-gradient(90deg, transparent 0%, color-mix(in srgb, var(--dsw-alias-bg-base) 60%, transparent) 55%, transparent 100%);pointer-events:none;width:300px;animation:2.6s ease-out infinite aCs5ca_dsh-tool-row-sweep;position:absolute;top:0;bottom:0;left:0}@keyframes aCs5ca_dsh-tool-row-sweep{0%{left:-300px}90%,to{left:100%}}.aCs5ca_leading{flex-shrink:0}.aCs5ca_root[data-tool^=cordis_] .aCs5ca_leading,.aCs5ca_root[data-tool^=cordis_] .aCs5ca_title{color:var(--dsw-alias-state-business-primary)}.aCs5ca_root[data-tool^=cordis_] .aCs5ca_title{font-weight:500}.aCs5ca_root[data-tool^=cordis_] .aCs5ca_sep{background:var(--dsw-alias-state-business-primary)}.aCs5ca_chevron{color:var(--dsw-alias-label-secondary)}.aCs5ca_title{font-weight:400}.aCs5ca_sep{background:var(--dsw-alias-label-caption);border-radius:1px;flex:none;width:2px;height:2px;margin:0 8px}.aCs5ca_summary{text-overflow:ellipsis;white-space:nowrap;min-width:0;color:var(--dsw-alias-label-tertiary);flex:auto;font-size:14px;line-height:24px;overflow:hidden}.aCs5ca_summarySuffix{white-space:nowrap;color:var(--dsw-alias-label-tertiary);flex:none;margin-left:4px;font-size:14px;line-height:24px}.aCs5ca_fileLink{text-overflow:ellipsis;white-space:nowrap;min-width:0;font:inherit;text-align:left;color:var(--dsw-alias-label-secondary);text-decoration:underline;text-decoration-color:var(--dsw-alias-label-quaternary);text-underline-offset:3px;cursor:pointer;background:0 0;border:none;flex:auto;margin:0;padding:0;font-size:14px;line-height:24px;overflow:hidden}.aCs5ca_fileLink:hover{color:var(--dsw-alias-label-primary);text-decoration-color:currentColor}.aCs5ca_errorSummary{color:var(--dsw-alias-state-error-primary)}.aCs5ca_bodyWrap{flex-direction:column;display:flex}.aCs5ca_inspectButton{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-base);color:var(--dsw-alias-label-secondary);cursor:pointer;opacity:0;border-radius:999px;align-self:flex-start;align-items:center;gap:4px;margin:4px 0 2px 4px;padding:2px 8px;font-size:11px;line-height:16px;transition:opacity .1s;display:inline-flex}.aCs5ca_root:hover .aCs5ca_inspectButton,.aCs5ca_inspectButton:focus-visible{opacity:1}.aCs5ca_inspectButton:hover{background:var(--dsw-alias-interactive-bg-hover-solid);color:var(--dsw-alias-label-primary)}.aCs5ca_bodyScroll{max-height:260px;overflow-y:auto}.aCs5ca_ioCard{border:1px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-markdown-code-block);font:var(--dsw-font-markdown-code-block-small);border-radius:12px;flex-direction:column;margin:4px 0 4px 4px;display:flex}.aCs5ca_ioSection{grid-template-columns:max-content 1fr;align-items:baseline;column-gap:14px;max-height:150px;padding:12px 16px;display:grid;overflow-y:auto}.aCs5ca_ioSection::-webkit-scrollbar-thumb{background-clip:padding-box;border:2px solid #0000;border-radius:6px}.aCs5ca_ioSection::-webkit-scrollbar-track{margin:6px 0}.aCs5ca_ioLabel{color:var(--dsw-alias-label-caption);align-self:start;position:sticky;top:0}.aCs5ca_ioDivider{background:var(--dsw-alias-border-l2);flex:none;height:1px}.aCs5ca_ioText{white-space:pre-wrap;word-break:break-word;min-width:0;color:var(--dsw-alias-label-secondary)}.aCs5ca_ioText[data-error]{color:var(--dsw-alias-state-error-primary)}.aCs5ca_codeBody,.aCs5ca_terminalBody,.aCs5ca_diffBody,.aCs5ca_readBody,.aCs5ca_searchBody,.aCs5ca_webBody{margin:4px 0 4px 4px}.aCs5ca_searchRecovery{white-space:pre-wrap;overflow-wrap:anywhere;font:var(--dsw-font-xs-13);color:var(--dsw-alias-label-tertiary);margin:4px 0 4px 4px}.aCs5ca_codeBody{--dsl-code-block-content-font:var(--dsw-font-markdown-code-block-small)}.aCs5ca_terminalBody{--dsl-terminal-font:var(--dsw-font-markdown-code-block-small);--dsl-terminal-line-height:18px;--dsl-terminal-output-max-height:224px;border:1px solid var(--dsw-alias-border-l1)}.aCs5ca_visuallyHidden{clip:rect(0 0 0 0);white-space:nowrap;width:1px;height:1px;position:absolute;overflow:hidden}";
		...
		var ToolRow_module_css_default = {
			"searchBody": "aCs5ca_searchBody",
			"readBody": "aCs5ca_readBody",
			"visuallyHidden": "aCs5ca_visuallyHidden",
			"bodyScroll": "aCs5ca_bodyScroll",
			"summarySuffix": "aCs5ca_summarySuffix",
			"webBody": "aCs5ca_webBody",
			"bodyWrap": "aCs5ca_bodyWrap",
			"codeBody": "aCs5ca_codeBody",
			"ioLabel": "aCs5ca_ioLabel",
			"ioCard": "aCs5ca_ioCard",
			"inspectButton": "aCs5ca_inspectButton",
			"ioSection": "aCs5ca_ioSection",
			"root": "aCs5ca_root",
			"diffBody": "aCs5ca_diffBody",
			"searchRecovery": "aCs5ca_searchRecovery",
			"leading": "aCs5ca_leading",
			"ioText": "aCs5ca_ioText",
			"chevron": "aCs5ca_chevron",
			"summary": "aCs5ca_summary",
			"sep": "aCs5ca_sep",
			"row": "aCs5ca_row",
			"fileLink": "aCs5ca_fileLink",
			"errorSummary": "aCs5ca_errorSummary",
			"title": "aCs5ca_title",
			"dsh-tool-row-sweep": "aCs5ca_dsh-tool-row-sweep",
			"ioDivider": "aCs5ca_ioDivider",
			"terminalBody": "aCs5ca_terminalBody"
		};
		//#endregion
		...
		*  summary already describe a settled row). */
		...
		//#endregion
		//#region \0dsh-css:D:\tool\deepseek-harness\packages\client\ui-tool\src\client\tool\ToolCallTree.module.css.mjs
		const css$2 = ".MMA8xW_callRow{border-radius:6px}.MMA8xW_subCalls{border-left:1px solid var(--dsw-alias-border-l2);flex-direction:column;gap:4px;margin:4px 0 2px 22px;padding-left:8px;display:flex}";
		...
		var ToolCallTree_module_css_default = {
			"callRow": "MMA8xW_callRow",
			"subCalls": "MMA8xW_subCalls"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:D:\tool\deepseek-harness\packages\client\ui-tool\src\client\tool\ToolDetails.module.css.mjs
		const css$1 = ".Y9XWdG_description{color:var(--dsw-alias-label-secondary);font:var(--dsw-font-xs-13);margin:0 0 6px}.Y9XWdG_cardBody{margin:0}.Y9XWdG_recovery{white-space:pre-wrap;overflow-wrap:anywhere;color:var(--dsw-alias-label-tertiary);font:var(--dsw-font-xs-13);margin:6px 0 0}.Y9XWdG_code{background:var(--dsw-alias-markdown-code-block);font-family:var(--ds-font-family-code);color:var(--dsw-alias-label-primary);white-space:pre-wrap;word-break:break-word;border-radius:12px;margin:0;padding:16px;font-size:13px;line-height:22px}.Y9XWdG_code[data-error]{color:var(--dsw-alias-state-error-primary)}.Y9XWdG_read,.Y9XWdG_web{margin:0}.Y9XWdG_empty{color:var(--dsw-alias-label-tertiary);padding:8px 0;font-size:13px;line-height:20px}";
		...
		var ToolDetails_module_css_default = {
			"empty": "Y9XWdG_empty",
			"read": "Y9XWdG_read",
			"recovery": "Y9XWdG_recovery",
			"description": "Y9XWdG_description",
			"cardBody": "Y9XWdG_cardBody",
			"code": "Y9XWdG_code",
			"web": "Y9XWdG_web"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:D:\tool\deepseek-harness\packages\client\ui-tool\src\client\tool\toolviews\bash-sample.module.css.mjs
		const css = ".p_wdcq_card{flex-direction:column;display:flex}.p_wdcq_terminal{--dsl-terminal-font:var(--dsw-font-markdown-code-block-small);--dsl-terminal-line-height:18px;--dsl-terminal-output-max-height:224px;border:1px solid var(--dsw-alias-border-l1);margin:4px 0 4px 4px}.p_wdcq_ioCard{border:1px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-markdown-code-block);font:var(--dsw-font-markdown-code-block-small);border-radius:12px;flex-direction:column;margin:4px 0 4px 4px;display:flex}.p_wdcq_ioSection{grid-template-columns:max-content 1fr;align-items:baseline;column-gap:14px;max-height:150px;padding:12px 16px;display:grid;overflow-y:auto}.p_wdcq_ioSection::-webkit-scrollbar-thumb{background-clip:padding-box;border:2px solid #0000;border-radius:6px}.p_wdcq_ioSection::-webkit-scrollbar-track{margin:6px 0}.p_wdcq_ioLabel{color:var(--dsw-alias-label-caption);align-self:start;position:sticky;top:0}.p_wdcq_ioDivider{background:var(--dsw-alias-border-l2);flex:none;height:1px}.p_wdcq_ioText{white-space:pre-wrap;word-break:break-word;min-width:0;color:var(--dsw-alias-label-secondary)}.p_wdcq_ioText[data-error]{color:var(--dsw-alias-state-error-primary)}.p_wdcq_root[data-expandable]{cursor:pointer}.p_wdcq_root{align-items:center;min-width:0;height:24px;display:flex;position:relative;overflow:hidden}.p_wdcq_root[data-state=running]:after{content:\"\";background:linear-gradient(90deg, transparent 0%, color-mix(in srgb, var(--dsw-alias-bg-base) 60%, transparent) 55%, transparent 100%);pointer-events:none;width:300px;animation:2.6s ease-out infinite p_wdcq_dsh-bash-row-sweep;position:absolute;top:0;bottom:0;left:0}@keyframes p_wdcq_dsh-bash-row-sweep{0%{left:-300px}90%,to{left:100%}}.p_wdcq_leading{width:16px;height:16px;color:var(--dsw-alias-label-tertiary);flex:none;justify-content:center;align-items:center;margin-right:6px;display:inline-flex;position:relative}.p_wdcq_chevron{color:var(--dsw-alias-label-secondary)}.p_wdcq_iconIdle{opacity:1;transition:opacity .1s;display:inline-flex}.p_wdcq_chevronHover{opacity:0;margin:auto;transition:opacity .1s;position:absolute;inset:0}.p_wdcq_root:hover .p_wdcq_iconIdle{opacity:0}.p_wdcq_root:hover .p_wdcq_chevronHover{opacity:1}.p_wdcq_title{color:var(--dsw-alias-label-secondary);flex:none;font-size:14px;line-height:24px}.p_wdcq_sep{background:var(--dsw-alias-label-caption);border-radius:1px;flex:none;width:2px;height:2px;margin:0 8px}.p_wdcq_summary{text-overflow:ellipsis;white-space:nowrap;min-width:0;color:var(--dsw-alias-label-tertiary);flex:auto;font-size:14px;line-height:24px;overflow:hidden}.p_wdcq_errorSummary{color:var(--dsw-alias-state-error-primary)}.p_wdcq_bodyWrap{flex-direction:column;display:flex}.p_wdcq_inspectButton{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-base);color:var(--dsw-alias-label-secondary);cursor:pointer;opacity:0;border-radius:999px;align-self:flex-start;align-items:center;gap:4px;margin:4px 0 2px 4px;padding:2px 8px;font-size:11px;line-height:16px;transition:opacity .1s;display:inline-flex}.p_wdcq_card:hover .p_wdcq_inspectButton,.p_wdcq_inspectButton:focus-visible{opacity:1}.p_wdcq_inspectButton:hover{background:var(--dsw-alias-interactive-bg-hover-solid);color:var(--dsw-alias-label-primary)}.p_wdcq_visuallyHidden{clip:rect(0 0 0 0);white-space:nowrap;width:1px;height:1px;position:absolute;overflow:hidden}";
		...
		var bash_sample_module_css_default = {
			"terminal": "p_wdcq_terminal",
			"card": "p_wdcq_card",
			"ioText": "p_wdcq_ioText",
			"sep": "p_wdcq_sep",
			"ioSection": "p_wdcq_ioSection",
			"bodyWrap": "p_wdcq_bodyWrap",
			"chevron": "p_wdcq_chevron",
			"inspectButton": "p_wdcq_inspectButton",
			"root": "p_wdcq_root",
			"errorSummary": "p_wdcq_errorSummary",
			"ioCard": "p_wdcq_ioCard",
			"ioLabel": "p_wdcq_ioLabel",
			"leading": "p_wdcq_leading",
			"visuallyHidden": "p_wdcq_visuallyHidden",
			"iconIdle": "p_wdcq_iconIdle",
			"title": "p_wdcq_title",
			"summary": "p_wdcq_summary",
			"ioDivider": "p_wdcq_ioDivider",
			"chevronHover": "p_wdcq_chevronHover",
			"dsh-bash-row-sweep": "p_wdcq_dsh-bash-row-sweep"
		};
		//#endregion
