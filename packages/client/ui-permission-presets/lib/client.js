window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:D:\tool\deepseek-harness\packages\client\ui-permission-presets\src\client\PermissionRow.module.css.mjs
		const css = "._5RWvOa_row{border-bottom:1px solid var(--dsw-alias-border-l2);align-items:center;gap:8px;padding:16px 0;display:flex}._5RWvOa_rowText{flex-direction:column;flex:1;gap:4px;min-width:0;padding-right:48px;display:flex}._5RWvOa_title{color:var(--dsw-alias-label-primary);font-size:14px;font-weight:400;line-height:22px}._5RWvOa_desc{color:var(--dsw-alias-label-tertiary);font-size:12px;font-weight:400;line-height:18px}._5RWvOa_selector{background:var(--dsw-alias-bg-module-platform);height:36px;font:inherit;color:var(--dsw-alias-label-primary);cursor:pointer;border:none;border-radius:18px;align-items:center;gap:12px;padding:0 14px;font-size:14px;line-height:22px;display:inline-flex}._5RWvOa_selector:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover)}._5RWvOa_selector:disabled{cursor:default}._5RWvOa_chevron{flex:none}";
		...
		var PermissionRow_module_css_default = {
			"chevron": "_5RWvOa_chevron",
			"rowText": "_5RWvOa_rowText",
			"title": "_5RWvOa_title",
			"row": "_5RWvOa_row",
			"desc": "_5RWvOa_desc",
			"selector": "_5RWvOa_selector"
		};
		//#endregion
