window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:D:\tool\deepseek-harness\packages\client\ui-workspace\src\client\rows\Rows.module.css.mjs
		const css$2 = ".ggvNIq_projectRow,.ggvNIq_sessionRow{cursor:pointer;user-select:none;color:var(--dsw-alias-label-primary);border-radius:8px;align-items:center;gap:6px;padding:0 8px;display:flex}.ggvNIq_projectRow:hover,.ggvNIq_sessionRow:hover,.ggvNIq_sessionRow.ggvNIq_selected{background:var(--dsw-alias-interactive-bg-hover)}.ggvNIq_searchResultRow{box-sizing:border-box;cursor:pointer;text-align:left;width:100%;min-height:48px;color:var(--dsw-alias-label-primary);background:0 0;border:none;border-radius:8px;flex-direction:column;align-items:stretch;padding:4px 8px;display:flex}.ggvNIq_searchResultRow:hover,.ggvNIq_searchResultRow.ggvNIq_selected{background:var(--dsw-alias-interactive-bg-hover)}.ggvNIq_searchResultHeading{align-items:center;min-width:0;display:flex}.ggvNIq_searchResultTitle{text-overflow:ellipsis;white-space:nowrap;min-width:0;margin-left:4px;font-size:14px;line-height:20px;overflow:hidden}.ggvNIq_searchResultMeta{align-items:center;gap:6px;min-width:0;margin-left:20px;display:flex}.ggvNIq_searchResultWorkspace,.ggvNIq_searchResultSnippet{text-overflow:ellipsis;white-space:nowrap;font-size:12px;line-height:17px;overflow:hidden}.ggvNIq_searchResultWorkspace{max-width:40%;color:var(--dsw-alias-label-tertiary);flex:none}.ggvNIq_searchResultSnippet{min-width:0;color:var(--dsw-alias-label-secondary);flex:1}.ggvNIq_projectRow{box-sizing:border-box;align-items:center;height:34px}.ggvNIq_projectRow .ggvNIq_rowActions{height:20px}.ggvNIq_sessionRow{height:32px;animation:ggvNIq_row-in .15s var(--ds-ease-in-out);gap:0}.ggvNIq_sessionRow .ggvNIq_title{margin:0 6px 0 4px}.ggvNIq_flatSessionRowWithoutStatus .ggvNIq_title{margin-left:0}@keyframes ggvNIq_row-in{0%{opacity:0}}.ggvNIq_slot{width:16px;height:20px;color:var(--dsw-alias-label-tertiary);flex:none;justify-content:center;align-items:center;display:inline-flex}.ggvNIq_visuallyHidden{clip:rect(0 0 0 0);white-space:nowrap;width:1px;height:1px;position:absolute;overflow:hidden}.ggvNIq_folderActive{color:var(--dsw-alias-state-business-primary)}.ggvNIq_projectRow .ggvNIq_chevron{display:none}.ggvNIq_projectRow:hover .ggvNIq_chevron{display:inline-flex}.ggvNIq_projectRow:hover .ggvNIq_folder{display:none}.ggvNIq_arrow{transition:transform .15s var(--ds-ease-in-out)}.ggvNIq_arrowOpen{transform:rotate(90deg)}.ggvNIq_projectText{flex-direction:column;flex:1;gap:2px;min-width:0;display:flex}.ggvNIq_title{text-overflow:ellipsis;white-space:nowrap;min-width:0;font-size:14px;line-height:20px;overflow:hidden}.ggvNIq_renameInput{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-button-elevated-fill);min-width:0;color:inherit;border-radius:4px;outline:none;padding:0 2px;font-size:14px;line-height:20px}.ggvNIq_sessionRow .ggvNIq_title{flex:1}.ggvNIq_meta{text-overflow:ellipsis;white-space:nowrap;color:var(--dsw-alias-label-tertiary);font-size:12px;line-height:20px;overflow:hidden}.ggvNIq_time{color:var(--dsw-alias-label-tertiary);flex:none;font-size:12px;line-height:20px}.ggvNIq_dot{flex:none}.ggvNIq_rowActions{flex:none;align-items:center;gap:12px;display:none}.ggvNIq_projectRow:hover .ggvNIq_rowActions,.ggvNIq_sessionRow:hover .ggvNIq_rowActions,.ggvNIq_projectRow.ggvNIq_menuOpen .ggvNIq_rowActions,.ggvNIq_sessionRow.ggvNIq_menuOpen .ggvNIq_rowActions{display:inline-flex}.ggvNIq_sessionRow:hover .ggvNIq_time,.ggvNIq_sessionRow.ggvNIq_menuOpen .ggvNIq_time{display:none}.ggvNIq_projectRow.ggvNIq_menuOpen,.ggvNIq_sessionRow.ggvNIq_menuOpen{background:var(--dsw-alias-interactive-bg-hover)}.ggvNIq_sessionRow.ggvNIq_dropBefore,.ggvNIq_sessionRow.ggvNIq_dropAfter{position:relative}.ggvNIq_sessionRow.ggvNIq_dropBefore:before,.ggvNIq_sessionRow.ggvNIq_dropAfter:after{content:\"\";z-index:1;background:linear-gradient(55deg, transparent calc(50% - 1px), var(--dsw-alias-state-business-primary) calc(50% - 1px) calc(50% + 1px), transparent calc(50% + 1px)) 0 0 / 5px 7px no-repeat, linear-gradient(125deg, transparent calc(50% - 1px), var(--dsw-alias-state-business-primary) calc(50% - 1px) calc(50% + 1px), transparent calc(50% + 1px)) 0 5px / 5px 7px no-repeat, linear-gradient(var(--dsw-alias-state-business-primary) 0 0) 4px 5px / calc(100% - 4px) 2px no-repeat;pointer-events:none;height:12px;position:absolute;left:0;right:4px}.ggvNIq_sessionRow.ggvNIq_dropBefore:before{top:-7px}.ggvNIq_sessionRow.ggvNIq_dropAfter:after{bottom:-7px}.ggvNIq_hoverContent{flex-direction:column;gap:8px;display:flex}.ggvNIq_hoverTitle{color:#fff;overflow-wrap:break-word;font-size:14px;line-height:20px}.ggvNIq_hoverPath{color:#cfd3d6;word-break:break-all;font-size:12px;line-height:16px}.ggvNIq_hoverTime{color:#cfd3d6;font-size:12px;line-height:16px}.ggvNIq_hoverStatus{color:#adb2b8;align-items:center;gap:8px;font-size:12px;line-height:20px;display:flex}.ggvNIq_iconButton{cursor:pointer;width:16px;height:16px;color:var(--dsw-alias-label-tertiary);background:0 0;border:none;border-radius:4px;flex:none;justify-content:center;align-items:center;padding:0;display:inline-flex}.ggvNIq_iconButton:hover{color:var(--dsw-alias-label-primary)}.ggvNIq_chevron{color:var(--dsw-alias-label-caption)}@media (prefers-reduced-motion:reduce){.ggvNIq_sessionRow,.ggvNIq_arrow{transition:none;animation:none}}";
		...
		var Rows_module_css_default = {
			"arrow": "ggvNIq_arrow",
			"iconButton": "ggvNIq_iconButton",
			"sessionRow": "ggvNIq_sessionRow",
			"meta": "ggvNIq_meta",
			"projectRow": "ggvNIq_projectRow",
			"visuallyHidden": "ggvNIq_visuallyHidden",
			"slot": "ggvNIq_slot",
			"hoverTitle": "ggvNIq_hoverTitle",
			"dropBefore": "ggvNIq_dropBefore",
			"searchResultRow": "ggvNIq_searchResultRow",
			"selected": "ggvNIq_selected",
			"searchResultWorkspace": "ggvNIq_searchResultWorkspace",
			"searchResultHeading": "ggvNIq_searchResultHeading",
			"flatSessionRowWithoutStatus": "ggvNIq_flatSessionRowWithoutStatus",
			"time": "ggvNIq_time",
			"projectText": "ggvNIq_projectText",
			"hoverContent": "ggvNIq_hoverContent",
			"dot": "ggvNIq_dot",
			"rowActions": "ggvNIq_rowActions",
			"title": "ggvNIq_title",
			"chevron": "ggvNIq_chevron",
			"arrowOpen": "ggvNIq_arrowOpen",
			"searchResultSnippet": "ggvNIq_searchResultSnippet",
			"hoverPath": "ggvNIq_hoverPath",
			"renameInput": "ggvNIq_renameInput",
			"folder": "ggvNIq_folder",
			"searchResultMeta": "ggvNIq_searchResultMeta",
			"hoverTime": "ggvNIq_hoverTime",
			"searchResultTitle": "ggvNIq_searchResultTitle",
			"row-in": "ggvNIq_row-in",
			"folderActive": "ggvNIq_folderActive",
			"dropAfter": "ggvNIq_dropAfter",
			"hoverStatus": "ggvNIq_hoverStatus",
			"menuOpen": "ggvNIq_menuOpen"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:D:\tool\deepseek-harness\packages\client\ui-workspace\src\client\WorkspacePicker.module.css.mjs
		const css$1 = ".MUfhCq_modalAction{min-width:72px}.MUfhCq_modalError,.MUfhCq_menuStatus{margin-top:8px;font-size:12px;line-height:18px}.MUfhCq_modalError{color:var(--dsw-alias-state-error-primary)}.MUfhCq_menuStatus{color:var(--dsw-alias-label-secondary)}";
		...
		var WorkspacePicker_module_css_default = {
			"menuStatus": "MUfhCq_menuStatus",
			"modalError": "MUfhCq_modalError",
			"modalAction": "MUfhCq_modalAction"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:D:\tool\deepseek-harness\packages\client\ui-workspace\src\client\WorkspaceBrowser.module.css.mjs
		const css = "._1_LSsW_root{--dsh-session-list-edge-inset:var(--dsh-sidebar-inline-padding);--dsh-session-list-scrollbar-width:8px;--dsh-session-list-scrollbar-offset:2px;box-sizing:border-box;min-height:0;padding-right:var(--dsh-session-list-edge-inset);flex-direction:column;flex:1;display:flex}._1_LSsW_root._1_LSsW_rail{padding-right:0}._1_LSsW_iconButton{cursor:pointer;width:28px;height:28px;color:var(--dsw-alias-label-secondary);background:0 0;border:none;border-radius:50%;flex:none;justify-content:center;align-items:center;padding:0;display:inline-flex}._1_LSsW_iconButton:hover{background:var(--dsw-alias-interactive-bg-hover)}._1_LSsW_sectionHeader{box-sizing:border-box;height:36px;color:var(--dsw-alias-label-tertiary);border-radius:12px;flex:none;justify-content:flex-end;align-items:center;gap:4px;margin-bottom:4px;padding-left:4px;display:flex;overflow:hidden}._1_LSsW_root:not(._1_LSsW_rail) ._1_LSsW_sectionHeader{margin-top:2px;margin-right:-4px}._1_LSsW_sectionLabel{white-space:nowrap;opacity:1;visibility:visible;min-width:0;max-width:45%;transition:max-width .18s var(--ds-ease-in-out), margin-right .18s var(--ds-ease-in-out), opacity .12s var(--ds-ease-in-out), transform .18s var(--ds-ease-in-out), visibility 0s linear;flex:none;line-height:20px;overflow:hidden}._1_LSsW_sectionLabelHidden{opacity:0;visibility:hidden;max-width:0;margin-right:-4px;transition-delay:0s,0s,0s,0s,.18s;transform:translate(-4px)}._1_LSsW_searchSlot{box-sizing:border-box;min-width:0;max-width:28px;transition:max-width .18s var(--ds-ease-in-out), padding-left .18s var(--ds-ease-in-out);flex:1;align-items:center;margin-left:auto;padding-left:0;display:flex}._1_LSsW_searchSlotExpanded{max-width:100%;padding-left:0}._1_LSsW_headerActions{opacity:1;visibility:visible;max-width:60px;transition:max-width .18s var(--ds-ease-in-out), opacity .12s var(--ds-ease-in-out), transform .18s var(--ds-ease-in-out), visibility 0s linear;flex:none;align-items:center;gap:4px;display:flex;overflow:hidden}._1_LSsW_headerActionsHidden{opacity:0;visibility:hidden;pointer-events:none;max-width:0;transition-delay:0s,0s,0s,.18s;transform:translate(4px)}._1_LSsW_search{box-sizing:border-box;cursor:text;width:100%;height:28px;color:var(--dsw-alias-label-secondary);transition:width .18s var(--ds-ease-in-out), padding .18s var(--ds-ease-in-out), border-color .18s var(--ds-ease-in-out), background-color .18s var(--ds-ease-in-out);background:0 0;border:none;border-radius:50%;flex:none;align-items:center;gap:0;margin:0;padding:0;display:flex;overflow:hidden}._1_LSsW_searchExpanded{border:1px solid var(--dsw-alias-border-l2);width:calc(100% + 4px);height:30px;color:var(--dsw-alias-label-caption);background:0 0;border-radius:10px;margin-inline:-2px;padding:0 4px 0 0}._1_LSsW_searchButton{cursor:pointer;width:28px;height:28px;color:inherit;background:0 0;border:none;border-radius:50%;flex:none;justify-content:center;align-items:center;padding:0;display:inline-flex}._1_LSsW_searchExpanded ._1_LSsW_searchButton{width:28px;height:30px}._1_LSsW_searchButton:hover{background:var(--dsw-alias-interactive-bg-hover)}._1_LSsW_searchExpanded ._1_LSsW_searchButton:hover{background:0 0}._1_LSsW_searchInput{opacity:0;pointer-events:none;width:0;min-width:0;color:var(--dsw-alias-label-primary);transition:opacity .12s var(--ds-ease-in-out);background:0 0;border:none;outline:none;flex:1;font-size:13px;line-height:18px}._1_LSsW_searchExpanded ._1_LSsW_searchInput{opacity:1;pointer-events:auto;margin-left:-2px}._1_LSsW_searchInput::placeholder{color:var(--dsw-alias-label-tertiary)}._1_LSsW_clearButton{cursor:pointer;width:24px;height:24px;color:var(--dsw-alias-label-secondary);background:0 0;border:none;border-radius:50%;flex:none;justify-content:center;align-items:center;padding:0;display:inline-flex}._1_LSsW_clearButton:hover{background:var(--dsw-alias-interactive-bg-hover)}._1_LSsW_rail ._1_LSsW_sectionHeader{justify-content:flex-start;gap:0;margin-bottom:12px;padding-left:0}._1_LSsW_rail ._1_LSsW_headerActions{max-width:none}._1_LSsW_rail ._1_LSsW_iconButton{width:36px;height:36px;color:var(--dsw-alias-label-primary)}._1_LSsW_rail ._1_LSsW_search{background:0 0;border-color:#0000;gap:0;width:36px;height:36px;margin:0 0 12px;padding:0}._1_LSsW_rail ._1_LSsW_searchButton{width:36px;height:36px;color:var(--dsw-alias-label-primary)}._1_LSsW_rail ._1_LSsW_searchButton:hover{background:var(--dsw-alias-interactive-bg-hover)}._1_LSsW_listArea{min-height:0;margin-left:-4px;margin-right:calc(-1 * var(--dsh-session-list-edge-inset));flex-direction:column;flex:1;padding-left:4px;display:flex;overflow:visible}._1_LSsW_rail ._1_LSsW_listArea{margin-left:0;margin-right:0;padding-left:0}._1_LSsW_treeBody{flex-direction:column;flex:1;min-height:0;display:flex;position:relative}._1_LSsW_fade{left:0;right:var(--dsh-session-list-edge-inset);background:linear-gradient(to bottom, transparent, var(--dsw-specific-sidebar-fill));pointer-events:none;height:24px;position:absolute;bottom:0}._1_LSsW_wide{animation:_1_LSsW_wide-in .2s var(--ds-ease-in-out)}@keyframes _1_LSsW_wide-in{0%{opacity:0}}._1_LSsW_list{min-height:0;margin-left:-4px;margin-right:var(--dsh-session-list-scrollbar-offset);padding-left:4px;padding-right:calc(var(--dsh-session-list-edge-inset) - var(--dsh-session-list-scrollbar-width) - var(--dsh-session-list-scrollbar-offset));scrollbar-gutter:stable;flex:1;padding-bottom:16px;overflow-y:auto}._1_LSsW_flatList>*+*,._1_LSsW_searchTree>[role=treeitem]+[role=treeitem],._1_LSsW_groupSection>*+*{margin-top:2px}._1_LSsW_searchStatus,._1_LSsW_searchWarning{color:var(--dsw-alias-label-tertiary);padding:10px 12px;font-size:12px;line-height:18px}._1_LSsW_searchWarning{color:var(--dsw-alias-label-secondary)}._1_LSsW_groupSection{position:relative}._1_LSsW_groupSection+._1_LSsW_groupSection{margin-top:4px}._1_LSsW_listTopDropIndicator,._1_LSsW_workspaceDropBefore:before,._1_LSsW_workspaceDropAfter:after{content:\"\";z-index:1;background:linear-gradient(55deg, transparent calc(50% - 1px), var(--dsw-alias-state-business-primary) calc(50% - 1px) calc(50% + 1px), transparent calc(50% + 1px)) 0 0 / 5px 7px no-repeat, linear-gradient(125deg, transparent calc(50% - 1px), var(--dsw-alias-state-business-primary) calc(50% - 1px) calc(50% + 1px), transparent calc(50% + 1px)) 0 5px / 5px 7px no-repeat, linear-gradient(var(--dsw-alias-state-business-primary) 0 0) 4px 5px / calc(100% - 4px) 2px no-repeat;pointer-events:none;height:12px;position:absolute;left:0;right:0}._1_LSsW_listTopDropIndicator{top:-8px;left:0;right:var(--dsh-session-list-edge-inset)}._1_LSsW_listTopDropActive>._1_LSsW_workspaceDropBefore:first-child:before{display:none}._1_LSsW_workspaceDropBefore:before{top:-8px}._1_LSsW_workspaceDropAfter:after{bottom:-8px}._1_LSsW_sessionOverflowButton{cursor:pointer;text-align:left;width:100%;height:28px;color:var(--dsw-alias-label-tertiary);background:0 0;border:none;border-radius:8px;padding:0 12px 0 28px;font-size:12px}._1_LSsW_groupSection>._1_LSsW_sessionOverflowButton{margin-top:0}._1_LSsW_sessionOverflowButton:hover{color:var(--dsw-alias-label-secondary);background:0 0}._1_LSsW_empty{color:var(--dsw-alias-label-tertiary);padding:16px 12px;font-size:13px}._1_LSsW_renameInput{box-sizing:border-box;border:1px solid var(--dsw-alias-border-l2);width:100%;height:44px;color:var(--dsw-alias-label-primary);background:0 0;border-radius:22px;outline:none;padding:7px 14px;font-size:14px;font-weight:400;line-height:22px}._1_LSsW_renameInput:disabled{color:var(--dsw-alias-label-dimmed)}._1_LSsW_renameError{color:var(--dsw-alias-state-error-primary);margin-top:8px;font-size:12px;line-height:18px}._1_LSsW_deleteAction:not(:disabled){color:var(--dsw-alias-state-error-primary)}._1_LSsW_deleteStatus{color:var(--dsw-alias-label-secondary);font-size:12px;line-height:18px}@media (prefers-reduced-motion:reduce){._1_LSsW_wide{animation:none}._1_LSsW_search,._1_LSsW_sectionLabel,._1_LSsW_searchSlot,._1_LSsW_searchInput,._1_LSsW_headerActions{transition:none}}";
		...
		var WorkspaceBrowser_module_css_default = {
			"clearButton": "_1_LSsW_clearButton",
			"sectionLabelHidden": "_1_LSsW_sectionLabelHidden",
			"sectionHeader": "_1_LSsW_sectionHeader",
			"search": "_1_LSsW_search",
			"sessionOverflowButton": "_1_LSsW_sessionOverflowButton",
			"listTopDropActive": "_1_LSsW_listTopDropActive",
			"empty": "_1_LSsW_empty",
			"groupSection": "_1_LSsW_groupSection",
			"workspaceDropAfter": "_1_LSsW_workspaceDropAfter",
			"treeBody": "_1_LSsW_treeBody",
			"searchTree": "_1_LSsW_searchTree",
			"searchSlot": "_1_LSsW_searchSlot",
			"headerActionsHidden": "_1_LSsW_headerActionsHidden",
			"searchExpanded": "_1_LSsW_searchExpanded",
			"searchButton": "_1_LSsW_searchButton",
			"wide": "_1_LSsW_wide",
			"searchWarning": "_1_LSsW_searchWarning",
			"listArea": "_1_LSsW_listArea",
			"renameInput": "_1_LSsW_renameInput",
			"renameError": "_1_LSsW_renameError",
			"iconButton": "_1_LSsW_iconButton",
			"root": "_1_LSsW_root",
			"rail": "_1_LSsW_rail",
			"listTopDropIndicator": "_1_LSsW_listTopDropIndicator",
			"searchInput": "_1_LSsW_searchInput",
			"sectionLabel": "_1_LSsW_sectionLabel",
			"deleteAction": "_1_LSsW_deleteAction",
			"deleteStatus": "_1_LSsW_deleteStatus",
			"workspaceDropBefore": "_1_LSsW_workspaceDropBefore",
			"searchSlotExpanded": "_1_LSsW_searchSlotExpanded",
			"fade": "_1_LSsW_fade",
			"searchStatus": "_1_LSsW_searchStatus",
			"headerActions": "_1_LSsW_headerActions",
			"wide-in": "_1_LSsW_wide-in",
			"flatList": "_1_LSsW_flatList",
			"list": "_1_LSsW_list"
		};
		//#endregion
