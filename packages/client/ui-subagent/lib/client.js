window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#region \0dsh-css:D:\tool\deepseek-harness\packages\client\ui-subagent\src\client\SubagentCatalogAction.module.css.mjs
		const css$1 = ".P5zR_a_root{position:relative}.P5zR_a_trigger{min-height:28px;color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:0;border-radius:6px;align-items:center;gap:3px;padding:3px 2px;font-size:12px;line-height:18px;display:inline-flex}.P5zR_a_count{margin:0 5px}.P5zR_a_activitySlot{flex:none;width:10px;height:10px;display:inline-flex}.P5zR_a_trigger:hover,.P5zR_a_trigger:focus-visible{color:var(--dsw-alias-label-secondary)}.P5zR_a_trigger svg{transition:transform .12s}.P5zR_a_triggerOpen{transform:rotate(180deg)}.P5zR_a_menu{z-index:100;box-sizing:border-box;background:var(--dsw-specific-menu);--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);width:336px;max-width:min(400px,100vw - 32px);max-height:min(560px,100vh - 140px);box-shadow:var(--dsw-shadow-lv3);border-radius:12px;flex-direction:column;padding:4px;display:flex;position:absolute;top:calc(100% + 5px);left:0;overflow:auto}.P5zR_a_node{min-width:0;position:relative}.P5zR_a_menu>.P5zR_a_node{margin-left:-3px}.P5zR_a_row{box-sizing:border-box;width:100%;min-height:50px;color:var(--dsw-alias-label-primary);text-align:left;cursor:pointer;background:0 0;border:0;border-radius:8px;outline:none;align-items:flex-start;gap:8px;padding:7px 8px 7px 11px;font-size:13px;line-height:18px;display:flex;position:relative}.P5zR_a_row:hover>.P5zR_a_clickarea,.P5zR_a_row:focus-visible>.P5zR_a_clickarea{background:var(--dsw-alias-interactive-bg-hover)}.P5zR_a_clickarea{box-sizing:border-box;border-radius:8px;flex:1;align-self:stretch;align-items:flex-start;gap:8px;min-width:0;margin:-7px -8px;padding:7px 8px;display:flex}.P5zR_a_row>[data-state],.P5zR_a_clickarea>[data-state]{margin-top:4px}.P5zR_a_disabled{color:var(--dsw-alias-label-dimmed);cursor:not-allowed}.P5zR_a_disabled:hover{background:0 0}.P5zR_a_loadingRow{cursor:default}.P5zR_a_disclosure,.P5zR_a_disclosureSpace{flex:none;width:14px;height:18px}.P5zR_a_disclosure{color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:0;justify-content:center;align-items:center;padding:0;transition:transform .12s;display:inline-flex}.P5zR_a_disclosure:hover{color:var(--dsw-alias-label-primary)}.P5zR_a_disclosureOpen{transform:rotate(90deg)}.P5zR_a_content{flex-direction:column;flex:1;min-width:0;display:flex}.P5zR_a_label,.P5zR_a_summary{text-overflow:ellipsis;white-space:nowrap;overflow:hidden}.P5zR_a_label{color:inherit;font-weight:400}.P5zR_a_summary,.P5zR_a_metrics{color:var(--dsw-alias-label-tertiary);font-size:11px;line-height:16px}.P5zR_a_metrics{font-variant-numeric:tabular-nums;text-align:right;white-space:nowrap;flex:none;grid-template-rows:18px 16px;display:grid}.P5zR_a_metricToken{grid-row:1;line-height:18px}.P5zR_a_metricDuration{grid-row:2}.P5zR_a_children{margin-left:18px;padding-left:4px;position:relative}.P5zR_a_children:before,.P5zR_a_children>.P5zR_a_node:before{content:\"\";border-left:1px solid var(--dsw-alias-border-l2);position:absolute;left:0}.P5zR_a_children:before{height:26px;top:-26px}.P5zR_a_children[aria-busy=true]:before{content:none}.P5zR_a_children>.P5zR_a_node:before{top:0;bottom:0;left:-4px}.P5zR_a_children>.P5zR_a_node:last-child:before{height:17px;bottom:auto}.P5zR_a_children>.P5zR_a_node>.P5zR_a_row:before{content:\"\";border-top:1px solid var(--dsw-alias-border-l2);width:14px;position:absolute;top:16px;left:-4px}.P5zR_a_notice,.P5zR_a_error{color:var(--dsw-alias-label-tertiary);padding:10px 12px;font-size:12px;line-height:18px}.P5zR_a_error{color:var(--dsw-alias-state-error-primary);justify-content:space-between;align-items:center;gap:12px;display:flex}.P5zR_a_refresh{color:inherit;cursor:pointer;background:0 0;border:0;border-radius:6px;flex:none;align-items:center;gap:4px;padding:4px 6px;display:inline-flex}.P5zR_a_refresh:hover{background:var(--dsw-alias-interactive-bg-hover)}";
		...
		var SubagentCatalogAction_module_css_default = {
			"summary": "P5zR_a_summary",
			"notice": "P5zR_a_notice",
			"metricToken": "P5zR_a_metricToken",
			"activitySlot": "P5zR_a_activitySlot",
			"menu": "P5zR_a_menu",
			"node": "P5zR_a_node",
			"disclosureOpen": "P5zR_a_disclosureOpen",
			"trigger": "P5zR_a_trigger",
			"triggerOpen": "P5zR_a_triggerOpen",
			"disclosureSpace": "P5zR_a_disclosureSpace",
			"clickarea": "P5zR_a_clickarea",
			"metricDuration": "P5zR_a_metricDuration",
			"content": "P5zR_a_content",
			"label": "P5zR_a_label",
			"error": "P5zR_a_error",
			"refresh": "P5zR_a_refresh",
			"row": "P5zR_a_row",
			"children": "P5zR_a_children",
			"metrics": "P5zR_a_metrics",
			"count": "P5zR_a_count",
			"loadingRow": "P5zR_a_loadingRow",
			"disabled": "P5zR_a_disabled",
			"root": "P5zR_a_root",
			"disclosure": "P5zR_a_disclosure"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:D:\tool\deepseek-harness\packages\client\ui-subagent\src\client\SubagentReadOnlyComposer.module.css.mjs
		const css = ".Gqw4Wa_frame{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-layer-1);min-height:54px;color:var(--dsw-alias-label-tertiary);border-radius:14px;justify-content:center;align-items:center;gap:8px;margin:0 24px 20px;padding:10px 16px;font-size:13px;line-height:20px;display:flex}.Gqw4Wa_frame strong{color:var(--dsw-alias-label-primary);font-weight:510}";
		...
		var SubagentReadOnlyComposer_module_css_default = { "frame": "Gqw4Wa_frame" };
		//#endregion
