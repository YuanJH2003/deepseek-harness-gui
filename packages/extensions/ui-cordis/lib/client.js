window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:D:\tool\deepseek-harness\packages\extensions\ui-cordis\src\client\CordisRunRow.module.css.mjs
		const css$2 = ".llZ4RW_card{flex-direction:column;gap:8px;display:flex}.llZ4RW_row{align-items:center;min-height:32px;display:flex}.llZ4RW_icon{color:var(--dsw-alias-state-business-primary);flex:none;margin-right:8px;display:inline-flex}.llZ4RW_title{color:var(--dsw-alias-state-business-primary);flex:none;font-size:14px;font-weight:500;line-height:24px}.llZ4RW_separator{background:var(--dsw-alias-state-business-primary);border-radius:50%;flex:none;width:2px;height:2px;margin:0 8px}.llZ4RW_summary,.llZ4RW_error{min-width:0;color:var(--dsw-alias-label-secondary);text-overflow:ellipsis;white-space:nowrap;flex:1;font-size:13px;line-height:24px;overflow:hidden}.llZ4RW_error{color:var(--dsw-alias-state-error-primary)}.llZ4RW_status{color:var(--dsw-alias-label-caption);flex:none;margin-left:8px;font-size:12px;line-height:24px}.llZ4RW_card[data-cordis-status=awaiting-approval] .llZ4RW_status,.llZ4RW_card[data-cordis-status=client-pending] .llZ4RW_status{color:var(--dsw-alias-state-warn-label)}.llZ4RW_card[data-cordis-status=running] .llZ4RW_status{color:var(--dsw-alias-state-success-primary)}.llZ4RW_card[data-cordis-status=failed] .llZ4RW_status{color:var(--dsw-alias-state-error-primary)}.llZ4RW_inspect{width:24px;height:24px;color:var(--dsw-alias-label-tertiary);cursor:pointer;opacity:0;background:0 0;border:none;border-radius:999px;justify-content:center;align-items:center;margin-left:4px;padding:0;display:inline-flex}.llZ4RW_card:hover .llZ4RW_inspect,.llZ4RW_inspect:focus-visible{opacity:1}.llZ4RW_inspect:hover{background:var(--dsw-alias-interactive-bg-hover)}.llZ4RW_message{background:var(--dsw-alias-button-ghost-active-fill);color:var(--dsw-alias-label-tertiary);border-radius:8px;padding:8px 12px;font-size:12px;line-height:18px}.llZ4RW_business{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-base);border-radius:12px;min-width:0;overflow:hidden}.llZ4RW_output{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-markdown-code-block);color:var(--dsw-alias-label-secondary);font:var(--dsw-font-markdown-code-block-small);white-space:pre-wrap;overflow-wrap:anywhere;border-radius:8px;margin:0;padding:10px 12px;overflow:auto}.llZ4RW_business .llZ4RW_output{border:none;border-radius:0}";
		...
		var CordisRunRow_module_css_default = {
			"status": "llZ4RW_status",
			"icon": "llZ4RW_icon",
			"title": "llZ4RW_title",
			"summary": "llZ4RW_summary",
			"message": "llZ4RW_message",
			"separator": "llZ4RW_separator",
			"row": "llZ4RW_row",
			"business": "llZ4RW_business",
			"error": "llZ4RW_error",
			"inspect": "llZ4RW_inspect",
			"card": "llZ4RW_card",
			"output": "llZ4RW_output"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:D:\tool\deepseek-harness\packages\extensions\ui-cordis\src\client\CordisDefineRow.module.css.mjs
		const css$1 = ".VgLRlG_card{flex-direction:column;display:flex}.VgLRlG_card .VgLRlG_title,.VgLRlG_card .VgLRlG_chevron{color:var(--dsw-alias-state-business-primary)}.VgLRlG_title{flex:none;font-size:14px;font-weight:500;line-height:24px}.VgLRlG_row{gap:0}.VgLRlG_separator{background:var(--dsw-alias-state-business-primary);border-radius:1px;flex:none;width:2px;height:2px;margin:0 8px}.VgLRlG_name{text-overflow:ellipsis;white-space:nowrap;max-width:40%;color:var(--dsw-alias-label-secondary);flex:none;font-size:14px;line-height:24px;overflow:hidden}.VgLRlG_purpose{text-overflow:ellipsis;white-space:nowrap;min-width:0;color:var(--dsw-alias-label-tertiary);flex:auto;margin-left:8px;font-size:13px;line-height:24px;overflow:hidden}.VgLRlG_errorSummary{text-overflow:ellipsis;white-space:nowrap;min-width:0;color:var(--dsw-alias-state-error-primary);flex:auto;font-size:14px;line-height:24px;overflow:hidden}.VgLRlG_requestError{text-overflow:ellipsis;white-space:nowrap;max-width:40%;color:var(--dsw-alias-state-error-primary);flex:none;margin-left:8px;font-size:12px;line-height:24px;overflow:hidden}.VgLRlG_readout{flex:none;align-items:center;margin-left:8px;display:inline-flex}.VgLRlG_panelHint{color:var(--dsw-alias-label-caption);margin:4px 0 2px 4px;font-size:11px;line-height:16px}.VgLRlG_statusLabel{color:var(--dsw-alias-label-caption);font-size:12px;line-height:24px}.VgLRlG_approvalPrompt{text-overflow:ellipsis;white-space:nowrap;max-width:40%;color:var(--dsw-alias-label-secondary);flex:none;margin-left:8px;font-size:12px;line-height:24px;overflow:hidden}.VgLRlG_notice{text-overflow:ellipsis;white-space:nowrap;max-width:40%;color:var(--dsw-alias-label-caption);flex:none;margin-left:8px;font-size:12px;line-height:24px;overflow:hidden}.VgLRlG_switch{height:22px;padding:0 8px;font-size:12px}.VgLRlG_card[data-terminal] .VgLRlG_title,.VgLRlG_card[data-terminal] .VgLRlG_name,.VgLRlG_card[data-terminal] .VgLRlG_purpose,.VgLRlG_card[data-terminal] .VgLRlG_statusLabel{color:var(--dsw-alias-label-caption)}.VgLRlG_card[data-terminal] .VgLRlG_separator{background:var(--dsw-alias-label-caption)}.VgLRlG_bodyWrap{flex-direction:column;display:flex}.VgLRlG_sourceCard{flex-direction:column;margin:4px 0 4px 4px;display:flex}.VgLRlG_sourceTabs{border-bottom:1px solid var(--dsw-alias-border-l2);height:32px;display:flex}.VgLRlG_sourceTab{color:var(--dsw-alias-label-tertiary);cursor:pointer;font:var(--dsw-font-xs-13);background:0 0;border:0;padding:0 10px;position:relative}.VgLRlG_sourceTab:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-primary)}.VgLRlG_sourceTab:disabled{cursor:default;opacity:.4}.VgLRlG_sourceTabActive{color:var(--dsw-alias-state-business-primary)}.VgLRlG_sourceTabActive:after{background:var(--dsw-alias-state-business-primary);content:\"\";border-radius:1px 1px 0 0;height:2px;position:absolute;bottom:0;left:10px;right:10px}.VgLRlG_sourceTab:focus-visible{outline:1px solid var(--dsw-alias-state-business-primary);outline-offset:-1px}.VgLRlG_sourcePanel{max-height:260px;overflow:auto}.VgLRlG_sourceCode{margin:0}.VgLRlG_codeSection{flex-direction:column;max-height:260px;margin:4px 0 4px 4px;display:flex;overflow:auto}.VgLRlG_sectionLabel{color:var(--dsw-alias-label-caption);text-transform:uppercase;letter-spacing:.04em;flex:none;padding:2px 0;font-size:11px;font-weight:500;line-height:16px}.VgLRlG_output{border:1px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-markdown-code-block);white-space:pre-wrap;overflow-wrap:anywhere;font:var(--dsw-font-markdown-code-block-small);color:var(--dsw-alias-label-secondary);border-radius:8px;margin:0;padding:8px 10px}.VgLRlG_output[data-error]{color:var(--dsw-alias-state-error-primary)}.VgLRlG_inspectButton{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-base);color:var(--dsw-alias-label-secondary);cursor:pointer;opacity:0;border-radius:999px;align-self:flex-start;align-items:center;gap:4px;margin:4px 0 2px 4px;padding:2px 8px;font-size:11px;line-height:16px;transition:opacity .1s;display:inline-flex}.VgLRlG_card:hover .VgLRlG_inspectButton,.VgLRlG_inspectButton:focus-visible{opacity:1}.VgLRlG_inspectButton:hover{background:var(--dsw-alias-interactive-bg-hover-solid);color:var(--dsw-alias-label-primary)}.VgLRlG_visuallyHidden{clip:rect(0 0 0 0);white-space:nowrap;width:1px;height:1px;position:absolute;overflow:hidden}@media (prefers-reduced-motion:reduce){.VgLRlG_inspectButton{transition:none}}";
		...
		var CordisDefineRow_module_css_default = {
			"title": "VgLRlG_title",
			"sourcePanel": "VgLRlG_sourcePanel",
			"card": "VgLRlG_card",
			"approvalPrompt": "VgLRlG_approvalPrompt",
			"codeSection": "VgLRlG_codeSection",
			"row": "VgLRlG_row",
			"sourceTab": "VgLRlG_sourceTab",
			"name": "VgLRlG_name",
			"switch": "VgLRlG_switch",
			"bodyWrap": "VgLRlG_bodyWrap",
			"statusLabel": "VgLRlG_statusLabel",
			"sourceCard": "VgLRlG_sourceCard",
			"panelHint": "VgLRlG_panelHint",
			"sourceTabActive": "VgLRlG_sourceTabActive",
			"output": "VgLRlG_output",
			"notice": "VgLRlG_notice",
			"chevron": "VgLRlG_chevron",
			"sourceCode": "VgLRlG_sourceCode",
			"inspectButton": "VgLRlG_inspectButton",
			"visuallyHidden": "VgLRlG_visuallyHidden",
			"requestError": "VgLRlG_requestError",
			"separator": "VgLRlG_separator",
			"errorSummary": "VgLRlG_errorSummary",
			"purpose": "VgLRlG_purpose",
			"readout": "VgLRlG_readout",
			"sourceTabs": "VgLRlG_sourceTabs",
			"sectionLabel": "VgLRlG_sectionLabel"
		};
		//#endregion
		...
		*/
		...
		//#endregion
		//#region \0dsh-css:D:\tool\deepseek-harness\packages\extensions\ui-cordis\src\client\CordisPanel.module.css.mjs
		const css = ".OE2WQq_layer{flex:none;align-items:center;width:100%;height:49px;margin:8px 0 0;display:flex;position:relative}.OE2WQq_footerButtons{align-items:center;width:100%;display:flex}.OE2WQq_badge{width:100%;height:49px;color:var(--dsw-alias-label-primary);cursor:pointer;background:0 0;border:none;border-radius:12px;align-items:center;gap:8px;padding:0 8px 0 6px;font-family:inherit;font-size:14px;display:inline-flex;overflow:hidden}.OE2WQq_badge:hover{background:var(--dsw-alias-interactive-bg-hover-solid)}.OE2WQq_badge[data-active]{background:var(--dsw-alias-interactive-bg-hover)}.OE2WQq_badgeLabel{text-overflow:ellipsis;white-space:nowrap;min-width:0;overflow:hidden}.OE2WQq_badgeCount{color:var(--dsw-alias-label-tertiary);font-variant-numeric:tabular-nums;flex:none;margin-left:auto;font-size:12px;line-height:16px}.OE2WQq_layer.OE2WQq_rail{width:36px;height:36px;margin:0}.OE2WQq_rail .OE2WQq_badge{border-radius:50%;justify-content:center;gap:0;width:36px;height:36px;padding:0}.OE2WQq_rail .OE2WQq_footerButtons{flex-direction:column;gap:2px}.OE2WQq_panel{z-index:30;border:1px solid var(--dsw-alias-border-l1);background:var(--dsw-alias-bg-base);width:420px;max-width:calc(100vw - 24px);max-height:60vh;box-shadow:var(--dsw-shadow-lv2);--dsh-scrollbar-thumb:var(--dsw-alias-scrollbar-bg-l2);--dsh-scrollbar-thumb-hover:var(--dsw-alias-scrollbar-hover-l2);border-radius:12px;flex-direction:column;display:flex;position:fixed;bottom:128px;left:12px;overflow:hidden}.OE2WQq_header{box-sizing:border-box;border-bottom:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-base);flex:none;justify-content:space-between;align-items:center;min-height:44px;padding:10px 12px;display:flex}.OE2WQq_body{flex:1;min-height:0;padding:4px 12px 12px;overflow-y:auto}.OE2WQq_title{color:var(--dsw-alias-label-primary);font-size:13px;font-weight:500;line-height:20px}.OE2WQq_note,.OE2WQq_readError{color:var(--dsw-alias-label-tertiary);margin:4px 0;font-size:12px;line-height:18px}.OE2WQq_readError{color:var(--dsw-alias-state-error-primary)}.OE2WQq_group{color:var(--dsw-alias-label-caption);text-transform:uppercase;letter-spacing:.04em;margin:8px 0 4px;font-size:11px;font-weight:500;line-height:16px}.OE2WQq_rows{flex-direction:column;gap:8px;margin:0;padding:0;list-style:none;display:flex}.OE2WQq_row{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-base);border-radius:12px;flex-direction:column;gap:8px;padding:10px 12px;display:flex}.OE2WQq_row[data-cordis-awaiting]{border-color:var(--dsw-alias-state-business-primary)}.OE2WQq_rowHead{align-items:center;gap:8px;display:flex}.OE2WQq_rowId{color:var(--dsw-alias-label-tertiary);font-family:var(--dsh-font-mono,monospace);flex:none;font-size:11px;line-height:20px}.OE2WQq_rowName{min-width:0;color:var(--dsw-alias-label-primary);text-overflow:ellipsis;white-space:nowrap;flex:1;font-size:13px;font-weight:500;line-height:20px;overflow:hidden}.OE2WQq_rowStatus{background:var(--dsw-alias-button-ghost-active-fill);height:20px;color:var(--dsw-alias-label-caption);border-radius:10px;flex:none;align-items:center;padding:0 6px;font-size:11px;line-height:20px;display:inline-flex}.OE2WQq_row[data-cordis-status=idle] .OE2WQq_rowStatus{background:var(--dsw-alias-button-ghost-active-fill);color:var(--dsw-alias-label-caption)}.OE2WQq_row[data-cordis-status=awaiting-approval] .OE2WQq_rowStatus,.OE2WQq_row[data-cordis-status=client-pending] .OE2WQq_rowStatus{background:var(--dsw-alias-state-warn-tertiary);color:var(--dsw-alias-state-warn-label)}.OE2WQq_row[data-cordis-status=failed] .OE2WQq_rowStatus{background:var(--dsw-alias-interactive-bg-hover-danger);color:var(--dsw-alias-state-error-primary)}.OE2WQq_row[data-cordis-status=running] .OE2WQq_rowStatus{background:var(--dsw-alias-state-success-tertiary);color:var(--dsw-alias-state-success-primary)}.OE2WQq_rowDetail{align-items:center;gap:8px;min-height:28px;display:flex}.OE2WQq_versionPicker{color:var(--dsw-alias-label-caption);align-items:center;gap:8px;font-size:11px;line-height:18px;display:flex}.OE2WQq_versionPicker select{border:1px solid var(--dsw-alias-border-l2);background:var(--dsw-alias-bg-base);min-width:0;height:26px;color:var(--dsw-alias-label-secondary);font:inherit;border-radius:7px;flex:1;padding:0 8px}.OE2WQq_rowPurpose{min-width:0;color:var(--dsw-alias-label-tertiary);text-overflow:ellipsis;white-space:nowrap;flex:1;font-size:12px;line-height:18px;overflow:hidden}.OE2WQq_rowError{color:var(--dsw-alias-state-error-primary);font-size:12px;line-height:18px}.OE2WQq_rowActions{flex:none;align-items:center;gap:10px;display:flex}.OE2WQq_transition{min-width:0;color:var(--dsw-alias-label-caption);align-items:center;gap:8px;font-size:11px;line-height:18px;display:flex}.OE2WQq_transitionActions{gap:6px;margin-left:auto;display:flex}.OE2WQq_transitionActions button{border:1px solid var(--dsw-alias-border-l2);color:var(--dsw-alias-label-secondary);font:inherit;cursor:pointer;background:0 0;border-radius:999px;padding:2px 8px}.OE2WQq_transitionActions button:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover)}.OE2WQq_transitionActions button:disabled{opacity:.4;cursor:default}.OE2WQq_activeVersion{color:var(--dsw-alias-label-caption);font-size:11px;line-height:16px}.OE2WQq_actionButton{width:28px;height:28px;color:var(--dsw-alias-label-tertiary);cursor:pointer;background:0 0;border:none;border-radius:999px;justify-content:center;align-items:center;padding:0;display:inline-flex}.OE2WQq_actionButton:hover:not(:disabled){background:var(--dsw-alias-interactive-bg-hover);color:var(--dsw-alias-label-secondary)}.OE2WQq_actionButton:disabled{opacity:.4;cursor:default}.OE2WQq_doubleCheck{width:17px;height:14px;display:inline-block;position:relative}.OE2WQq_doubleCheck svg{position:absolute;top:1px}.OE2WQq_doubleCheck svg:first-child{opacity:.7;left:0}.OE2WQq_doubleCheck svg:last-child{left:5px}";
		...
		var CordisPanel_module_css_default = {
			"activeVersion": "OE2WQq_activeVersion",
			"title": "OE2WQq_title",
			"badgeCount": "OE2WQq_badgeCount",
			"rowName": "OE2WQq_rowName",
			"transitionActions": "OE2WQq_transitionActions",
			"footerButtons": "OE2WQq_footerButtons",
			"rowHead": "OE2WQq_rowHead",
			"rowStatus": "OE2WQq_rowStatus",
			"rail": "OE2WQq_rail",
			"transition": "OE2WQq_transition",
			"badge": "OE2WQq_badge",
			"rowError": "OE2WQq_rowError",
			"actionButton": "OE2WQq_actionButton",
			"rows": "OE2WQq_rows",
			"rowId": "OE2WQq_rowId",
			"header": "OE2WQq_header",
			"group": "OE2WQq_group",
			"body": "OE2WQq_body",
			"rowPurpose": "OE2WQq_rowPurpose",
			"badgeLabel": "OE2WQq_badgeLabel",
			"panel": "OE2WQq_panel",
			"versionPicker": "OE2WQq_versionPicker",
			"rowActions": "OE2WQq_rowActions",
			"readError": "OE2WQq_readError",
			"row": "OE2WQq_row",
			"rowDetail": "OE2WQq_rowDetail",
			"doubleCheck": "OE2WQq_doubleCheck",
			"layer": "OE2WQq_layer",
			"note": "OE2WQq_note"
		};
		//#endregion
